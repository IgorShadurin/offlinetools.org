    ...
    <>
      ...
      <div className="space-y-6">
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li><strong>Keys (Property Names):</strong> Usually a distinct color.</li>
          <li><strong>String Values:</strong> Often a different color than keys.</li>
          <li><strong>Number Values:</strong> Another unique color.</li>
          <li><strong>Boolean Values (`true`, `false`):</strong> Distinct color, sometimes grouped with keywords.</li>
          <li><strong>Null Value (`null`):</strong> Distinct color, often grouped with keywords.</li>
          <li><strong>Structural Characters:</strong> Braces <code>&#x7b;&#x7d;</code>, brackets <code>&#x5b;&#x5d;</code>, colons <code>:</code>, and commas <code>,</code> might be a neutral color or slightly dimmed, but their presence and placement are key to structure.</li>
        </ul>
        ...
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">
            (Simulated colors: <span className="text-purple-600 dark:text-purple-400">Key</span>, <span className="text-cyan-600 dark:text-cyan-400">String Value</span>, <span className="text-amber-600 dark:text-amber-400">Number</span>, <span className="text-red-600 dark:text-red-400">Boolean/Null</span>, <span className="text-gray-600 dark:text-gray-400">Structure</span>)
          </p>
        ...
        <p>
         ...
         <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">
            (Simulated error highlight: <span className="bg-yellow-300 dark:bg-yellow-600 text-black px-1 rounded">Highlight</span>)
          </p>
          <div className="bg-white p-3 rounded dark:bg-gray-900 overflow-x-auto">
            <pre className="text-sm leading-relaxed">
              <code>
                ...
                <span className="text-cyan-600 dark:text-cyan-400">&quot;Value A&quot;</span>
                 <span className="bg-yellow-300 dark:bg-yellow-600 text-black px-1 rounded">{" "}</span> {" "} {/* Simulate error highlight here */}
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li><strong>Faster Reading:</strong> Quickly scan and understand the structure and data types.</li>
          <li><strong>Reduced Errors:</strong> Easily spot misplaced commas, colons, or mismatched braces/brackets.</li>
          <li><strong>Improved Debugging:</strong> When dealing with API responses or configuration files, highlighting helps isolate the data you're looking for.</li>
          <li><strong>Better Collaboration:</strong> Sharing formatted and highlighted JSON is clearer than sharing raw text.</li>
        </ul>
