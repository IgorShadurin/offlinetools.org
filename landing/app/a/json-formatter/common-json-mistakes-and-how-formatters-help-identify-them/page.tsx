...
export default function JsonMistakesAndFormattersArticle() {
    ...
    <>
      ...
      <div className="space-y-6 text-gray-800 dark:text-gray-200">
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>A collection of name/value pairs (typically implemented as an object, record, struct, dictionary, hash table, keyed list, or associative array).</li>
          <li>An ordered list of values (typically implemented as an array, vector, list, or sequence).</li>
        </ul>
        <p>
          Because it's a strict data format designed for interoperability, it has a rigid syntax. Unlike JavaScript object literals, which can be more forgiving, JSON parsers strictly adhere to the{" "}
          <a href="https://www.json.org/json-en.html" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline dark:text-blue-400">official JSON specification</a>. Any deviation from this specification will result in a parsing error.
        </p>
  ...
  "age": 30
        ...
        <p>
          JSON requires object keys to be strings, and strings must be enclosed in double quotes (<code className="font-mono">&quot;</code>). Single quotes (<code className="font-mono">&apos;</code>) are not allowed.
        </p>
         <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
  ...
  "name": "Alice"
        ...
        <p>
          JSON has specific primitive types: strings, numbers, booleans (<code className="font-mono">true</code>, <code className="font-mono">false</code>), and <code className="font-mono">null</code>.
        </p>
         <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
  ...
  "status": null
        ...
        <p>
          Certain characters within a JSON string must be escaped with a backslash (<code className="font-mono">\</code>), such as <code className="font-mono">&quot;</code>, <code className="font-mono">\</code>, and control characters.
        </p>
         <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
  ...
  "description": "This is a \\"quoted\\" word."
        ...
        <p>
          JSON does NOT support comments (neither single-line <code className="font-mono">{'//'}</code> nor multi-line <code className="font-mono">{'/* ... */'}</code>). This is a common source of errors when developers try to comment out parts of a JSON file.
        </p>
         <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
  ...
  "age": 30
        ...
        <p>
          A valid JSON document must have either a single object <code className="font-mono">&#x7b;...&#x7d;</code> or a single array <code className="font-mono">[...]</code> as its root element. A standalone string, number, boolean, or null is not a complete JSON document according to the most common interpretations and parsers.
        </p>
         <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li><strong>Highlight the exact location</strong> of the error (line number and column).</li>
          <li>Provide a helpful <strong>error message</strong> explaining what went wrong (e.g., "Unexpected token", "Missing comma", "Invalid value").</li>
        </ul>
        <p>
  ...
  "items": [
    ...
    },
    {
      ...
      "name": "Item B"
        ...
        <p>
          While some parsers (like JavaScript's <code className="font-mono">JSON.parse()</code>) might be slightly lenient with things like trailing commas in certain environments, relying on this is risky. A good JSON formatter enforces strict compliance with the JSON standard, ensuring your data is valid across different platforms and languages.
        </p>
