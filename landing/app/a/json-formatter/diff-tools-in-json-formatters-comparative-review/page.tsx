  ...
  "city": "New York"
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-2 my-4">
            ...
            <li>Shows *exact* textual changes, including comments (if allowed by the parser/formatter) or original formatting variations before formatting.</li>
            <li>Simple to implement.</li>
          </ul>
          <h3 className="text-xl font-semibold mt-6">Cons:</h3>
          <ul className="list-disc pl-6 space-y-2 my-4">
            <li>
              <span className="font-medium">Sensitive to non-semantic changes:</span> Changes in key order (which is not significant in JSON objects) or minor formatting variations not standardized by the formatter can appear as significant differences.
            </li>
            <li>
              <span className="font-medium">Doesn't understand structure:</span> It doesn't know if a change is within a string, a number, an array element, or a key name.
            </li>
...
+  "age": 30
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-2 my-4">
            ...
            <li>Added, removed, or changed elements in arrays (though array diffing can be complex, sometimes requiring configuration on how to match elements).</li>
            <li>Changes in primitive values (strings, numbers, booleans, null).</li>
          </ul>
          <h3 className="text-xl font-semibold mt-6">Pros:</h3>
          <ul className="list-disc pl-6 space-y-2 my-4">
            <li>
              <span className="font-medium">Accurate data comparison:</span> Ignores irrelevant formatting or key order differences.
            </li>
          ...
          <ul className="list-disc pl-6 space-y-2 my-4">
            ...
            <li>Array diffing can be tricky – simple tools might just mark arrays as changed if elements are reordered; advanced tools might use heuristics or specified key fields to match array elements.</li>
          </ul>
  ...
  "elderberry": Added at index 3`}
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-2 my-4">
            <li>
              <span className="font-medium">Customizable Formatting:</span> Control indentation level, spacing, and whether to sort keys. Consistency is key for text diffing.
            </li>
            <li>
              <span className="font-medium">Semantic Diff Mode:</span> The ability to compare structures directly, ignoring whitespace and key order. This is often the most useful for understanding data changes.
            </li>
            <li>
              <span className="font-medium">Array Comparison Strategy:</span> How the tool handles array differences (by index, by matching elements using a key, detecting moves).
            </li>
            <li>
              <span className="font-medium">Visual Output:</span> Clear side-by-side or inline views highlighting added, removed, and changed lines or values.
            </li>
            <li>
              <span className="font-medium">Handling Large Files:</span> Performance and memory usage when dealing with very large JSON documents.
            </li>
            <li>
              <span className="font-medium">Integration:</span> Command-line interface for scripting, web interface for manual comparison, API for programmatic use, or IDE integration.
            </li>
            <li>
              <span className="font-medium">Error Handling:</span> How the tool reports parsing errors in invalid JSON.
            </li>
            <li>
              <span className="font-medium">Ignoring Paths/Keys:</span> Ability to exclude specific keys or paths from the comparison (e.g., timestamps, unique IDs that are expected to change).
            </li>
          </ul>
        </section>
...
`}
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-2 my-4">
            <li>
              For simple comparison of small, consistently formatted files where you care about the exact text representation (e.g., documenting a minor change in a code example), a <strong>text diff on formatted JSON</strong> might suffice.
            </li>
            <li>
              For comparing configuration files, API responses, or large data structures where you want to understand the actual data differences regardless of formatting or key order, a <strong>structure-aware (semantic) diff tool</strong> is highly recommended. Many online and desktop JSON tools offer this mode.
            </li>
            <li>
