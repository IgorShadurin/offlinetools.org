    ...
    <>
      ...
      <div className="space-y-6 text-lg">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            <strong>Consistency:</strong> Enforce a consistent structure for different documentation sections or components.
          </li>
          <li>
            <strong>Integration:</strong> Integrate documentation content directly into applications, tools, or APIs.
          </li>
          <li>
            <strong>Version Control:</strong> Manage documentation changes alongside code in standard version control systems.
          </li>
        </ul>
        <p>
...
└── fr/
  ...
  "errors": [
    ...
    },
    {
      ...
      "message": "Se requiere autenticación y ha fallado o aún no se ha proporcionado."
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            <strong>Synchronization:</strong> Keeping the structure of files consistent across all languages can be challenging as documentation evolves.
          </li>
          <li>
  ...
  // ... other languages
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            <strong>Centralized:</strong> All language content for a specific document is in one place, easier for translators using tools.
          </li>
          <li>
            <strong>Structure Consistency:</strong> The base structure is maintained across languages.
          </li>
          <li>
            <strong>Reduced Redundancy (Option B):</strong> Non-translatable keys/values (like error codes) can potentially exist once outside language keys if the structure allows, or are simply part of the repeated structure.
          </li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            <strong>Loading Overhead:</strong> You load data for *all* languages even if only one is needed (though parsing can be optimized).
          </li>
          <li>
            <strong>Complexity (Option A):</strong> Deeply nested structures with language keys on every string can be verbose.
          </li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            ...
            <ul className="list-circle pl-6 space-y-1 mt-1">
              <li>For separate files: Load the specific JSON file corresponding to the active locale (e.g., <code>/docs/en/api_errors.json</code>).</li>
              <li>For single files with language keys: Load the single JSON file and then access the data under the key matching the active locale (e.g., <code>data[&apos;en&apos;]</code>).</li>
            </ul>
          </li>
          <li>
            <strong>Locale Detection:</strong> Determine the user&apos;s preferred language from browser settings, URL parameters, user profile, etc.
          </li>
          <li>
            <strong>Fallback Language:</strong> Define a default language (e.g., &quot;en&quot;) to use if the user&apos;s preferred language is not available.
          </li>
          <li>
            <strong>Data Access:</strong> Your application code will need to retrieve values based on the active language. For Option A (language keys per string), this might involve a helper function like <code>getText(key, locale)</code> that looks up <code>data[key][locale]</code> with a fallback. For Option B (top-level language keys), you&apos;d first select the language block <code>data[locale]</code> and then access keys within that block.
          </li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            <strong>Separate Files:</strong> Suitable for smaller projects, when content types vary significantly between &quot;documents&quot;, or when translation workflows are file-based. Offers good performance for loading only necessary data.
          </li>
          <li>
            <strong>Single File (Option B):</strong> Good for larger projects with many similar documents/components, where centralized translation is preferred, and where the size of the combined file is manageable. Simplifies structure management.
          </li>
          <li>
            <strong>Single File (Option A):</strong> Can work for simple, flat structures like configuration files, but quickly becomes cumbersome for complex, nested documentation structures.
          </li>
        </ul>
        <p className="flex items-start gap-2">
          <Info className="w-5 h-5 mt-1 text-blue-500 flex-shrink-0" />
          Consider using standard <a href="https://en.wikipedia.org/wiki/ISO_639-1" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">ISO 639-1 locale codes</a> (like &quot;en&quot;, &quot;es&quot;, &quot;fr&quot;, &quot;de&quot;) as your language keys or directory names for consistency and compatibility with i18n tools.
        </p>
