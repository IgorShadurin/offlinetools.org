...
export const metadata: Metadata = {
  ...
  description: "Learn how to effectively use watch expressions to inspect specific JSON properties while debugging, simplifying data inspection.",
};
...
export default function WatchExpressionsJsonArticle() {
  return (
    <>
      ...
      <div className="space-y-6 text-gray-800 dark:text-gray-200">
        ...
        <p>
          Instead of just watching a variable named <code className="font-mono bg-gray-200 dark:bg-gray-700 px-1 py-0.5 rounded text-sm">data</code> which might be a huge JSON object, you can watch something more specific like <code className="font-mono bg-gray-200 dark:bg-gray-700 px-1 py-0.5 rounded text-sm">data.userDetails.address.city</code> to see only the city value, even if <code className="font-mono bg-gray-200 dark:bg-gray-700 px-1 py-0.5 rounded text-sm">data</code> is megabytes large.
        </p>
        ...
        <p>
          Imagine you have a variable <code className="font-mono bg-gray-200 dark:bg-gray-700 px-1 py-0.5 rounded text-sm">userData</code> that holds a large JSON response from an API, structured like this:
        </p>
  ...
  // ... many other top-level properties
        ...
        <p>
          If you just watch <code className="font-mono bg-gray-200 dark:bg-gray-700 px-1 py-0.5 rounded text-sm">userData</code>, the Watch pane will show the entire structure. To see the user&apos;s city, you&apos;d have to manually expand <code className="font-mono bg-gray-200 dark:bg-gray-700 px-1 py-0.5 rounded text-sm">userData</code>, then <code className="font-mono bg-gray-200 dark:bg-gray-700 px-1 py-0.5 rounded text-sm">profile</code>, then <code className="font-mono bg-gray-200 dark:bg-gray-700 px-1 py-0.5 rounded text-sm">address</code>. This is time-consuming, especially if you need to check this value frequently or compare it across different breakpoints.
        </p>
...
userData.orders[1].totalAmount`}
        ...
        <p>
          If you are inside a loop iterating over the array (e.g., with index <code className="font-mono bg-gray-200 dark:bg-gray-700 px-1 py-0.5 rounded text-sm">i</code>), you can watch the current element or its properties dynamically:
        </p>
        <div className="bg-gray-100 dark:bg-gray-700 p-3 rounded-lg my-4 overflow-x-auto text-gray-900 dark:text-gray-50">
          <pre className="text-sm">
...
userData.profile.address["zipCode"]`}
        ...
        <p>
          If a property or nested path might not exist (e.g., an optional address field), accessing it directly like <code className="font-mono bg-gray-200 dark:bg-gray-700 px-1 py-0.5 rounded text-sm">userData.profile.billingAddress.city</code> could throw an error in some debuggers depending on when the watch expression is evaluated. To safely watch properties that might be null or undefined along the path, use optional chaining (<code className="font-mono bg-gray-200 dark:bg-gray-700 px-1 py-0.5 rounded text-sm">?.</code>):
        </p>
        <div className="bg-gray-100 dark:bg-gray-700 p-3 rounded-lg my-4 overflow-x-auto text-gray-900 dark:text-gray-50">
          <pre className="text-sm">
...
typeof userData.profile.address.zipCode`}
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            <strong className="font-semibold">Reduced Clutter:</strong> Your watch pane only shows the specific values you are interested in, making it much cleaner than expanding huge JSON trees.
          </li>
          <li>
            <strong className="font-semibold">Faster Inspection:</strong> Get instant visibility into deeply nested values without clicking through layers of objects and arrays.
          </li>
          <li>
            <strong className="font-semibold">Focused Debugging:</strong> Helps you concentrate on the relevant data points that might be causing a bug.
          </li>
          <li>
            <strong className="font-semibold">Dynamic Monitoring:</strong> Watch properties within loops using the loop index, seeing the value change with each iteration.
          </li>
          <li>
            <strong className="font-semibold">Direct Evaluation:</strong> Test property access paths or simple transformations directly in the debugger context.
          </li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            <strong>Browser Developer Tools (Chrome, Firefox, Edge, Safari):</strong> Look for a &quot;Watch&quot; or &quot;Scope&quot; pane in the Sources/Debugger tab. There is usually a &quot;+&quot; button or an input field to add new watch expressions.
          </li>
          <li>
            <strong>VS Code Debugger:</strong> In the &quot;Run and Debug&quot; view, there is a &quot;Watch&quot; section. Click the &quot;Add Expression&quot; button (often a &quot;+&quot; icon) or type into the input field that appears.
          </li>
          <li>
            <strong>Node.js Debugging:</strong> Similar to browser tools, often accessed via integrated developer environments or specific CLI debug tools.
          </li>
        </ul>
        <p>
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            <strong className="font-semibold">Scope:</strong> Ensure the variable you are trying to watch (<code className="font-mono bg-gray-200 dark:bg-gray-700 px-1 py-0.5 rounded text-sm">userData</code> in our examples) is actually in scope at the point where your debugger pauses. If it&apos;s not in scope, the watch expression will likely show an error like &quot;undefined&quot; or &quot;not available&quot;.
          </li>
          <li>
            <strong className="font-semibold">Performance:</strong> While usually negligible, extremely complex watch expressions or watching properties of massive objects evaluated very frequently could theoretically have a minor performance impact during debugging, especially in resource-constrained environments.
          </li>
          <li>
            <strong className="font-semibold">Syntax Errors:</strong> If your watch expression has a syntax error or tries to access a property on <code className="font-mono bg-gray-200 dark:bg-gray-700 px-1 py-0.5 rounded text-sm">null</code> or <code className="font-mono bg-gray-200 dark:bg-gray-700 px-1 py-0.5 rounded text-sm">undefined</code> without using optional chaining, the debugger will typically indicate an error instead of displaying a value.
          </li>
          <li>
            <strong className="font-semibold">Use Judiciously:</strong> Don&apos;t add dozens of watch expressions if you only need to check a value once. It&apos;s most useful for values you need to monitor repeatedly across different breakpoints or loop iterations.
          </li>
        </ul>
