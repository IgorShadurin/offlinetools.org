...
export default function JsonBasicsArticle() {
  return (
    <>
      ...
      <div className="space-y-6 text-lg leading-relaxed">
        <p>
          In the world of web development and data exchange, you&apos;ll constantly encounter
          a format called JSON. It stands for <strong>JavaScript Object Notation</strong>,
          and despite its name, it&apos;s used far beyond just JavaScript. It&apos;s the
          lingua franca for APIs, configuration files, and data storage in many modern
          applications.
        </p>
        <p>
          This guide will walk you through the fundamental rules of JSON formatting, making
          it easy to read, write, and understand.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">What is JSON?</h2>
        <p>
          At its core, JSON is a lightweight data-interchange format. It is easy for humans
          to read and write and easy for machines to parse and generate. It&apos;s based
          on a subset of the JavaScript programming language Standard ECMA-262 3rd Edition
          - December 1999. However, its syntax is independent of any programming language,
          making it a perfect choice for exchanging data between different systems or languages.
        </p>
        <p>
          Think of JSON as a structured way to represent data, much like how you&apos;d write
          down notes or lists with clear labels and organization.
        </p>
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            ...
            In JSON, this is an <strong>Object</strong>.
          </li>
          <li>
            An ordered list of values. In most languages, this is realized as an array,
            vector, list, or sequence. In JSON, this is an <strong>Array</strong>.
          </li>
        </ul>
        ...
        <p>
          JSON data is written as key/value pairs, just like properties in JavaScript objects.
          The key must be a string (enclosed in double quotes), followed by a colon (:),
        ...
        <p>
          A JSON <strong>Object</strong> is enclosed in curly braces <code>&#x7b; &#x7d;</code>.
  ...
  "isStudent": false
        ...
        <p>
          A JSON <strong>Array</strong> is enclosed in square brackets <code>[ ]</code>.
          Values within an array are separated by commas (,). Array values can be
          any valid JSON data type (strings, numbers, objects, other arrays, booleans, null).
        </p>
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4 overflow-x-auto">
          <pre className="text-sm">
            {`[
  ...
  { "id": 2, "name": "Item B" }
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            <strong>String:</strong> A sequence of Unicode characters enclosed in double quotes.
          ...
          <li>
            <strong>Number:</strong> An integer or a floating-point number. Scientific notation is allowed.
            Must NOT have leading zeros (unless it&apos;s just `0`) or trailing decimal points.
            <div className="bg-gray-100 p-3 rounded my-2 dark:bg-gray-900 overflow-x-auto">
        ...
        <p>
          Whitespace between JSON elements (like spaces, tabs, and newlines) is ignored.
          This allows for &quot;pretty-printing&quot; JSON with indentation to make it more readable.
        </p>
         <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4 overflow-x-auto">
          <pre className="text-sm">
            {`{
  ...
  "isActive": true
        ...
        <p>
          JSON has strict formatting rules. Unlike JavaScript object literals, these things
          will cause a JSON parser to fail:
        </p>
        <ul className="list-disc pl-6 space-y-2">
          <li>
            <strong>Using single quotes for strings or keys:</strong> Always use double quotes <code>&quot; &quot;</code>.
            <div className="bg-gray-100 p-3 rounded my-2 dark:bg-gray-900 overflow-x-auto">
          ...
          <li>
           ...
           <li>
            <strong>Using non-standard values:</strong> Things like <code>undefined</code>, JavaScript functions, or <code>NaN</code> are not valid JSON values.
             <div className="bg-gray-100 p-3 rounded my-2 dark:bg-gray-900 overflow-x-auto">
        ...
        <p>
          Because the rules are strict, it&apos;s easy to make formatting mistakes.
          Fortunately, many online tools (search for &quot;JSON validator&quot;) can help
          you check if your JSON is correctly formatted and highlight any errors. Most
          code editors also provide syntax highlighting and formatting for JSON files,
          which can catch simple errors quickly.
        </p>
        <p>
          In programming languages, built-in functions (like <code>JSON.parse()</code> in
          JavaScript or equivalent functions in Python, Java, etc.) will throw an error
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            <strong>Direct Mapping to Data Structures:</strong> JSON objects map naturally to dictionaries/hash maps, and JSON arrays map to lists/arrays in most languages.
          </li>
        </ul>

        <h2 className="text-2xl font-semibold mt-8 mb-4">Conclusion</h2>
        <p>
          Understanding JSON formatting is a fundamental skill for any modern developer.
          By sticking to its simple rules – using double quotes for keys and strings,
          separating pairs and values with commas, and enclosing objects in braces and
          arrays in brackets – you can effectively exchange data with APIs, configure
          applications, and store structured information. Remember to validate your JSON
          if you encounter parsing errors, as even small syntax mistakes can cause issues.
        </p>
      </div>
    </>
  );
