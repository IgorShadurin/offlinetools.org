      ...
      <div className="space-y-6">
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li className="flex items-start">
            ...
            <div>
              <strong>Charter:</strong> A mission statement defining the scope and goal of the session (e.g., &quot;Explore input validation with malformed JSON&quot;).
            </div>
          </li>
          <li className="flex items-start">
            <Timer size={20} className="mr-2 mt-1 text-muted-foreground flex-shrink-0" />
            <div>
              <strong>Timeboxing:</strong> Sessions have a defined duration, typically 60-120 minutes. This helps maintain focus and provides measurable output.
            </div>
          </li>
          <li className="flex items-start">
            <FileJson size={20} className="mr-2 mt-1 text-muted-foreground flex-shrink-0" />
            <div>
              <strong>Session Notes/Report:</strong> Testers record what they did, what they observed (bugs, questions, ideas), and the overall outcome of the session. This provides a record and metrics (like test coverage notes or bug find rates).
            </div>
          </li>
          <li className="flex items-start">
            <BrainCircuit size={20} className="mr-2 mt-1 text-muted-foreground flex-shrink-0" />
            <div>
              <strong>Accountability:</strong> The session report makes the testing process transparent and allows for review and coaching.
            </div>
          </li>
        </ul>
        <p>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li className="flex items-start">
            ...
            <div>
              <strong>User Workflow Emulation:</strong> SBT allows testers to simulate how a real user might interact with the tool, including typical copy-paste operations, editing, and applying various settings.
            </div>
          </li>
          <li className="flex items-start">
            <Bug size={20} className="mr-2 mt-1 text-muted-foreground flex-shrink-0" />
            <div>
              <strong>Discovering Edge Cases:</strong> Exploratory sessions are excellent for probing the boundaries and error handling, especially with tricky or malformed JSON inputs.
            </div>
          </li>
          <li className="flex items-start">
            <Search size={20} className="mr-2 mt-1 text-muted-foreground flex-shrink-0" />
            <div>
              <strong>Input Variations:</strong> Testers can rapidly try a wide range of JSON structures, nesting levels, data types, and sizes.
            </div>
          </li>
          <li className="flex items-start">
            <Layers size={20} className="mr-2 mt-1 text-muted-foreground flex-shrink-0" />
            <div>
              <strong>Interaction with Features:</strong> How does formatting interact with validation errors? What happens if you format an extremely large file? SBT can explore these feature interactions.
            </div>
          </li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            ...
            <ul>
              <li>Focus: Missing commas, incorrect braces/brackets, unescaped quotes, trailing commas (if not supported), incorrect data types.</li>
          ...
          <li>
            ...
            <ul>
              <li>Focus: Indentation levels, sort keys option, compact vs. pretty print, handling of empty objects/arrays within nesting.</li>
          ...
          <li>
            ...
            <ul>
              <li>Focus: Inputting/formatting files &gt; 1MB or &gt; 10MB, deep nesting (e.g., 100 levels), large arrays (e.g., 10,000+ items).</li>
              <li>Expected outcome: Application remains responsive, doesn&apos;t crash, and completes formatting within reasonable time.</li>
            </ul>
          </li>
          <li>
            <span className="font-medium">Charter 4:</span> Verify specific data type handling.
            <ul>
              <li>Focus: Large numbers (beyond standard float precision), strings with special characters/unicode, boolean and null representations.</li>
              <li>Expected outcome: Data types are preserved and formatted correctly.</li>
            </ul>
          </li>
          <li>
            <span className="font-medium">Charter 5:</span> Explore interactions between features (e.g., formatting + validation).
            <ul>
              <li>Focus: What happens if you try to format invalid JSON? Are errors highlighted *before* or *after* attempting format?</li>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          ...
          <li>If a bug is found, briefly investigate to understand its scope, but don&apos;t spend the entire session debugging. Log it clearly.</li>
          <li>Stay focused on the charter, but allow for deviations if a promising area is discovered (&quot;opportunity&quot;). Note deviations in the report.</li>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          ...
          <li>Overall Session Outcome (e.g., &quot;Covered core formatting features, found 3 bugs related to malformed input.&quot;)</li>
        </ul>
        <p>
        ...
        <h3 className="text-xl font-semibold mt-6 flex items-center"><CheckCheck className="mr-2 text-green-500" size={20} /> Benefits in this Context:</h3>
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>Excellent for finding bugs related to diverse inputs and user interaction flows.</li>
          <li>Complements automated tests by exploring areas where automation is difficult (e.g., unexpected user inputs).</li>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li><strong>Variety is Key:</strong> Use a wide range of JSON examples – simple, complex, deeply nested, flat, large, small, including all data types.</li>
          <li><strong>Obtain Real-World Data:</strong> If possible, use sanitized real-world JSON data that users of the application might encounter.</li>
          <li><strong>Test Error States Deliberately:</strong> Don&apos;t just use valid JSON; intentionally introduce errors to test validation and error reporting.</li>
          <li><strong>Combine Features:</strong> Test how formatting interacts with validation, different output modes (copy, save), and other features.</li>
          <li><strong>Consider Performance:</strong> Have some very large JSON files ready to test performance and memory usage.</li>
          <li><strong>Collaborate:</strong> Share session reports and discuss findings with other testers and developers.</li>
        </ul>
