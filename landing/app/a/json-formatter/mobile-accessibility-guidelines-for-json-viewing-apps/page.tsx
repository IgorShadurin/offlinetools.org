    ...
    <>
      ...
      <div className="space-y-6">
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            <strong>Color Contrast:</strong> Ensure text and background colors meet WCAG AA or AAA contrast ratios. This is vital for users with low vision or color vision deficiencies. Provide theme options (light/dark mode) which often improves contrast choices.
          </li>
          <li>
            <strong>Syntax Colors:</strong> Use distinct colors for different JSON elements (keys, strings, numbers, booleans, null). These colors should also have good contrast against the background. Avoid relying *solely* on color to convey meaning.
          </li>
          <li>
            <strong>Formatting:</strong> Allow users to toggle between compact and pretty-printed (indented) JSON. Pretty-printing significantly improves readability.
          </li>
          <li>
            <strong>Line Wrapping:</strong> Long JSON lines that scroll horizontally are frustrating. Provide an option to wrap lines.
          </li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            <strong>Scalable Text:</strong> Use scalable units (like `sp` or `dp` on Android, dynamic type on iOS) for font sizes.
          </li>
          <li>
            <strong>Readable Font:</strong> Choose a clear, readable font. Monospace fonts are common for code but ensure they are accessible and support readability features like distinct &quot;l&quot;, &quot;1&quot;, and &quot;I&quot;.
          </li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            <strong>Clear Indicators:</strong> Use clear visual indicators (like arrows or plus/minus signs) for collapsible elements. Ensure these indicators are part of the touch target and are accessible to screen readers.
          </li>
          <li>
            <strong>State Persistence:</strong> Ideally, remember the collapse state when navigating back, or provide options to expand/collapse all nodes.
          </li>
          <li>
            <strong>Accessible Labels:</strong> The interactive element (the arrow or area to tap) should have an accessible label describing its state, e.g., &quot;Expand object&quot;, &quot;Collapse array&quot;.
          </li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            <strong>Semantic Elements:</strong> Use semantic HTML elements if the app uses web views, or the equivalent native components with accessibility properties. For example, treat collapsible nodes like disclosure widgets.
          </li>
          <li>
            <strong>Labels and Roles:</strong> Provide meaningful labels for all interactive elements. Clearly indicate the role of elements (e.g., &quot;object&quot;, &quot;array&quot;, &quot;string key&quot;, &quot;number value&quot;).
          </li>
          <li>
            <strong>State Announcement:</strong> When a node is expanded or collapsed, the screen reader should announce the change in state (e.g., &quot;object collapsed&quot;, &quot;array expanded, 5 items&quot;).
          </li>
          <li>
            <strong>Content Description:</strong> For complex values (like nested objects/arrays), provide a concise description for the screen reader initially, allowing the user to expand for details. E.g., instead of reading out the entire nested structure, say &quot;object, collapsed, 7 keys&quot;.
          </li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            <strong>Focus Management:</strong> Clearly indicate the currently focused element. Ensure focus order is logical (e.g., traverse keys and values sequentially, or allow moving into/out of collapsed nodes).
          </li>
          <li>
            <strong>Interactive Elements:</strong> Collapsible indicators and any other interactive elements must be reachable via keyboard focus and activatable using Enter/Space.
          </li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          ...
          <li>
            <strong>Accessible Search Results:</strong> When search results are highlighted, the highlighting should have good contrast. Provide controls to navigate between results (e.g., &quot;Next&quot;, &quot;Previous&quot;), which should be keyboard and screen reader accessible.
          </li>
          <li>
            <strong>Error Reporting:</strong> If the user enters invalid search syntax or the search fails, provide clear, accessible error messages.
          </li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          ...
          <li>
            <strong>Font Preferences:</strong> As mentioned, font size control is key. Allowing users to select specific accessible fonts could be beneficial.
          </li>
          <li>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          ...
          <li>
            <strong>Automated Tools:</strong> Use available accessibility scanners for mobile platforms (e.g., Accessibility Scanner for Android, Accessibility Inspector for iOS) to catch common issues like low contrast and missing labels.
          </li>
          <li>
