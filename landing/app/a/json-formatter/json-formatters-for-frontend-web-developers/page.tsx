    ...
    <>
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <p className="mt-4">
            A <strong>JSON formatter</strong> (also known as a JSON pretty-printer) is a tool or function that takes a JSON string as input and outputs a new string that is formatted with consistent indentation, line breaks, and spacing. This structured output makes the data much more readable and easier to debug.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-2 mt-4">
            ...
            <li>Working with local configuration files (like <code>package.json</code>, build tool configs).</li>
          ...
          <ul className="list-disc pl-6 space-y-2 mt-4">
            ...
            <li>
              <strong>Consistency:</strong> Ensure JSON files in your project adhere to a standard style, improving collaboration and reducing merge conflicts in version control.
            </li>
            <li>
        ...
        <section>
          ...
          <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
            <p className="text-sm text-gray-700 dark:text-gray-300">
              <strong>Tip:</strong> If your browser isn't auto-formatting, check browser settings or consider a browser extension designed for JSON viewing.
            </p>
          </div>
          ...
          <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
            ...
            <p className="text-sm">
              Open a <code>.json</code> file. Right-click and select "Format Document", or use the keyboard shortcut (e.g., Shift+Alt+F on Windows/Linux, Shift+Option+F on macOS). Configure default formatters or use extensions like Prettier.
            </p>
          </div>
          ...
          <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
            <p className="text-sm text-gray-700 dark:text-gray-300">
              <strong>Security Note:</strong> For production or sensitive data, prefer offline methods (IDE, programmatic) over online tools.
            </p>
          </div>

          <h3 className="text-xl font-semibold mt-6 mb-3">4. Programmatic Formatting (using JavaScript/TypeScript)</h3>
          <p>
            You can format JSON within your code, most commonly for logging, generating output files, or sending readable responses (though API responses are usually minified for efficiency). The built-in <code>JSON.stringify()</code> method is perfect for this.
          </p>

          <h4 className="text-lg font-medium mt-4 mb-2">Using <code>JSON.stringify()</code> for Pretty-Printing</h4>
          <p>
            The third argument of <code>JSON.stringify()</code> controls indentation. You can pass a number (for spaces) or a string (like a tab character).
          </p>
          <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
...
console.log(prettyJsonWithTabs);`}
            ...
            <h5 className="text-base font-medium mt-4 mb-2">The Replacer Argument</h5>
             <p className="text-sm">The second argument (<code>null</code> in the examples above) is the `replacer`. It can be an array of keys to include or a function to transform values. This is less common for simple *formatting* but useful for controlling *what* gets serialized.</p>
             <div className="bg-white p-3 rounded dark:bg-gray-900 overflow-x-auto">
              <pre>
...
console.log(filteredJson); // Only shows name and age`}
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <strong>Performance with Large Data:</strong> Formatting very large JSON strings programmatically can be memory-intensive or slow.
            </li>
            <li>
              <strong>Circular References:</strong> <code>JSON.stringify()</code> will throw an error if the object contains circular references (where an object references itself or an ancestor in its properties).
            </li>
            <li>
              <strong>Data Loss/Transformation:</strong> <code>JSON.stringify()</code> serializes only basic JSON types. Functions, Symbols, and <code>undefined</code> properties are omitted. Dates are converted to strings.
            </li>
            <li>
              <strong>Key Order:</strong> The JSON specification does not guarantee key order. While `JSON.stringify` often serializes keys in a specific order (often insertion order or sorted, depending on the engine), formatters *don't* typically sort keys alphabetically by default, although some advanced tools offer this as an option. Don't rely on key order.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            JSON formatters are simple yet powerful tools that significantly enhance the daily workflow of a frontend developer. Whether you rely on browser developer tools, IDE extensions, online utilities, or programmatic methods like <code>JSON.stringify()</code>, incorporating JSON formatting into your development process will save you time, reduce frustration, and lead to fewer errors when dealing with data. Master these techniques to make working with JSON a much smoother experience.
          </p>
        </section>
      </div>
    </>
