  ...
  return (
    <>
      ...
      <div className="space-y-6">
        <p>
          In modern web development, interacting with data, often delivered in JSON format, is fundamental. While
          JSON is highly efficient for machines, presenting it directly or building complex interfaces around it
          without careful design can significantly increase cognitive load for users. This is particularly
          problematic for individuals with cognitive disabilities, learning differences, or those relying on
          assistive technologies like screen readers. Reducing cognitive load in JSON interfaces is not just an
          accessibility concern; it benefits all users by making interfaces easier to understand and use.
        </p>
        ...
        <p>
          Cognitive load refers to the total amount of mental effort being used in the working memory. When an
          interface requires users to process too much information, make complex decisions, or navigate
          confusing structures, it increases cognitive load. High cognitive load can lead to:
        </p>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            <strong>Deep Nesting:</strong> Highly nested JSON requires users to hold a complex mental model of the data hierarchy. Navigating through levels like{" "}
            <code>user.profile.addresses[0].street</code> is harder than a flat structure.
          </li>
          <li>
            <strong>Ambiguous Keys:</strong> Short or cryptic JSON keys (e.g., <code>id</code>, <code>ts</code>, <code>cnt</code>) lack human-readable context without clear labels in the UI.
          </li>
          <li>
            <strong>Large Data Volume:</strong> Displaying vast amounts of JSON data without structure or filtering overwhelms users.
          </li>
          <li>
            <strong>Inconsistent Structure:</strong> APIs or data sources that return JSON with inconsistent key names, data types, or structures make prediction and understanding difficult.
          </li>
          <li>
            <strong>Raw Presentation:</strong> Showing raw JSON text, while useful for developers, is inaccessible and cognitively demanding for general users.
          </li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            **Tables (<Table className="inline-block ml-1" size={16} />):** Use for tabular data (arrays of objects with consistent keys). Ensure proper table headers (`&lt;th&gt;`) for screen readers and clear column labels.
          </li>
          <li>
            **Lists (<List className="inline-block ml-1" size={16} />):** Use for arrays of items or key-value pairs. Use semantic lists (`&lt;ul&gt;`, `&lt;ol&gt;`) and descriptive list item content.
          </li>
          <li>
            **Cards (<LayoutGrid className="inline-block ml-1" size={16} />):** Use for presenting individual objects from an array, summarizing key information on the card and allowing drill-down for details.
          </li>
          <li>
...
*/`}
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            **Expandable Sections (<ChevronDown className="inline-block ml-1" size={16} />):** Hide nested objects or arrays within expandable/collapsible sections. Use ARIA attributes like `aria-expanded` and `aria-controls`.
          </li>
          <li>
...
*/`}
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            **Filters (<Filter className="inline-block ml-1" size={16} />):** Based on key data points. Use accessible form controls (`&lt;select&gt;`, `&lt;input type=&quot;checkbox&quot;&gt;`, etc.) with clear labels.
          </li>
          <li>
          ...
          <li>
            **Search (<Search className="inline-block ml-1" size={16} />):** Implement a search function to find items containing specific text. Use a standard search input with an associated label.
          </li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          ...
          <li>
            ...
            <ul className="list-circle pl-4 mt-2">
              ...
              <li>`role`: Clarify the purpose of non-semantic elements if necessary (use sparingly, prefer semantic HTML).</li>
            </ul>
          </li>
          <li>
...
*/`}
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          ...
          <li>
            **Icons (<Lightbulb className="inline-block ml-1" size={16} />):** Use simple, universally understood icons sparingly to supplement text labels, not replace them entirely, unless context is very clear. Ensure icons have accessible text alternatives (e.g., via `aria-label` or surrounding text).
          </li>
        </ul>
