    ...
    <div className="p-6 border rounded-lg bg-card text-card-foreground shadow-sm">
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="mb-2">
            This tool calculates cryptographic hashes for text input using various algorithms (like MD5, SHA-1, SHA-256,
            SHA-512). Hashing produces a fixed-size string (the hash) representing the input text. It&apos;s commonly
        ...
        <div>
          ...
          <ol className="list-decimal pl-6 space-y-3">
            <li>
              ...
              <p>
                Generate a hash for text, transmit the text and hash separately, and re-calculate the hash on the
                receiving end to ensure the text wasn&apos;t altered during transmission or storage.
              </p>
            </li>
            ...
            <li>
              ...
              <p>
                Illustrate the basic concept of password hashing (note: use salted, strong algorithms like Argon2/bcrypt
                in production).
              </p>
            </li>
            ...
            <li>
              ...
              <p>
                Quickly check if two pieces of text (e.g., code snippets, configuration blocks) are identical by
            ...
            <li>
              ...
              <p>
                Understand how hashing text is the first step in creating or verifying digital signatures (which also
            ...
            <li>
              ...
              <p>
                Demonstrate properties of hash functions like determinism and the avalanche effect (small input change =
                large output change).
              </p>
            </li>
          </ol>
        ...
        <div>
          ...
          <p>
            The tool utilizes the browser&apos;s built-in <code>SubtleCrypto</code> API, part of the Web Cryptography
            API, to perform hashing. The input text is first encoded into a <code>Uint8Array</code> (typically using
            UTF-8 encoding). This array is then passed to the <code>SubtleCrypto.digest()</code> method along with the
            chosen algorithm (e.g., <code>SHA-256</code>). The result is an <code>ArrayBuffer</code> containing the raw
            hash bytes, which is then converted to a hexadecimal string for display. For HMAC,{" "}
            <code>SubtleCrypto.sign()</code> is used with a derived key. All cryptographic operations occur securely
            within the browser.
          </p>
        </div>
      </div>
