...
export const metadata: Metadata = {
  ...
  description: "Learn why JSON only supports double quotes as string delimiters, common errors when using single quotes, and how to fix them.",
};
    ...
    <ArticlePromoProvider value={jsonFormatterPromo}>
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6">
          <p>
            One of the most common errors when working with JSON is using the wrong type of quotes for strings.
            Unlike many programming languages that accept either single or double quotes, JSON has a strict requirement:
            strings must be enclosed in double quotes only. This article explains why this restriction exists,
            how it causes problems, and how to avoid or fix these issues.
          </p>

          <h2 className="text-2xl font-semibold mt-8">The JSON Specification and Quotes</h2>
          <p>
            According to the official JSON specification, strings in JSON must be enclosed in double quotes.
            This is a non-negotiable rule that affects both keys and values:
          </p>
...
{`{
  ...
  'age': 30
            ...
            <p className="mt-2 text-sm">This will result in a syntax error since all strings must use double quotes consistently.</p>
          </div>
          ...
          <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
            <ul className="list-disc ml-6 space-y-2">
              ...
              <li>Historical reasons: JSON was derived from JavaScript object notation, which supports double quotes for strings</li>
          ...
          <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
            ...
            <p className="mt-2 text-sm">This regular expression finds text between single quotes and replaces the single quotes with double quotes.</p>
          </div>
          
          <h3 className="text-xl font-semibold mt-6">2. Using JSON Formatter Tools</h3>
          <p>
            JSON formatter tools like the one provided by Offline Tools can automatically detect and repair quote delimiter issues.
            Simply paste your JSON with incorrect quotes, and the tool will attempt to fix the formatting.
          </p>
...
json_string = json.dumps(python_dict)  # Results in {"name": "John", "age": 30}`}
          ...
          <div className="bg-yellow-50 p-4 rounded-lg dark:bg-yellow-900/30 my-6 border-l-4 border-yellow-400">
            ...
            <p className="mt-2 text-yellow-700 dark:text-yellow-200">
              When programmatically generating JSON, use your language&apos;s built-in JSON serialization functions rather than
              constructing JSON strings manually. This helps avoid quote delimiter issues and other syntax errors.
            </p>
          </div>
        </div>
