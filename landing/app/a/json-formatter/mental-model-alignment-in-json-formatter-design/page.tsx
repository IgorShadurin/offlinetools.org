...
import { Brain, Code, Grid, Eye, Settings, Check, X, LayoutList, TextSelect, Quote, IndentIncrease } from 'lucide-react'; // Only explicitly listed icons

export const metadata: Metadata = {
  title: "Mental Model Alignment in JSON Formatter Design | Offline Tools",
  description: "Explore how aligning JSON formatter design with user mental models improves usability and understanding.",
};
  ...
  return (
    <>
      ...
      <div className="space-y-6">
        <p>
          When developers interact with tools, they bring a set of assumptions about how things work. These assumptions form their <strong>mental models</strong>. A well-designed tool, like a JSON formatter, aligns with these existing mental models, making it intuitive, predictable, and pleasant to use. A mismatch, however, leads to confusion, frustration, and errors.
        </p>
        <p>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li><strong>Mental Model:</strong> Deeper nesting means more indentation. Siblings at the same level should have the same indentation. This mirrors file system structures, outlines, and code blocks in programming languages.</li>
          <li><strong>Alignment:</strong> Using a consistent number of spaces (e.g., 2 or 4) or tabs for each level of nesting directly aligns with this model.</li>
          <li><strong>Mismatch:</strong> Inconsistent indentation, or using indentation that doesn&apos;t clearly show the parent-child relationship, violates this model and makes the structure hard to follow.</li>
        </ul>
        <p>
    ...
    "hobbies": [
      ...
      "coding"
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li><strong>Mental Model 1 (Insertion Order):</strong> Keys appear in the order they were written in the original string. This preserves the author&apos;s intent or a specific historical view.</li>
          <li><strong>Mental Model 2 (Alphabetical Order):</strong> Keys are sorted alphabetically. This provides consistency, makes it easy to find a specific key, and aligns with dictionary/lexical ordering models.</li>
          <li><strong>Alignment:</strong> Offering an option to preserve original order or sort alphabetically caters to different mental models and use cases (debugging vs. browsing).</li>
          <li><strong>Mismatch:</strong> Sorting unexpectedly when a user expects original order, or presenting in a seemingly random order, violates the predictability model.</li>
        </ul>
        <p>
    ...
    "name": "Charlie"
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li><strong>Mental Model:</strong> Strings are clearly delimited by double quotes. Special characters within strings (like <code>&quot;</code>, <code>\</code>, newlines) are properly escaped (<code>\&quot;</code>, <code>\\</code>, <code>\n</code>).</li>
          <li><strong>Alignment:</strong> Always using double quotes for keys and string values, and correctly applying escape sequences, reinforces the standard JSON string model. Highlighting strings distinctly also helps.</li>
          <li><strong>Mismatch:</strong> Using single quotes (invalid JSON), failing to escape characters, or displaying raw control characters breaks the model of what a valid JSON string looks like.</li>
        </ul>
        <p>
    ...
    "path": "C:\\\\users\\\\document"
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li><strong>Mental Model:</strong> Numbers, booleans (<code>true</code>, <code>false</code>), and <code>null</code> are distinct from strings. They don&apos;t have quotes. Numbers follow standard numeric formats.</li>
          <li><strong>Alignment:</strong> Using syntax highlighting to color-code different data types (strings, numbers, booleans, null, keys) strongly aligns with this model, making the structure immediately understandable. Presenting numbers in a standard format without extraneous characters (unless part of the number spec, like exponents).</li>
          <li><strong>Mismatch:</strong> Displaying numbers or booleans within quotes (making them look like strings), or failing to visually distinguish types, makes it harder to quickly scan and understand the data content.</li>
        </ul>
        <p>
    ...
    "metadata": null      // Null
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li><strong>Mental Model:</strong> Complex structures can be overwhelming. There should be ways to simplify the view, like collapsing sections. Arrays with many items or objects with many keys should be manageable.</li>
          <li><strong>Alignment:</strong> Features like collapsible nodes (objects or arrays) or limiting the visible number of array items per line align with the model of needing to manage complexity. Providing summaries (e.g., &quot;Array [50 items]&quot;) is also helpful.</li>
          <li><strong>Mismatch:</strong> Just dumping the entire deeply nested or massive structure without any navigation or collapse options violates the model of needing tools to handle scale.</li>
        </ul>
        <p>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li><strong>Reduced Cognitive Load:</strong> Users spend less time figuring out how the formatter works and more time understanding the data itself.</li>
          <li><strong>Increased Efficiency:</strong> Navigating, reading, and debugging JSON becomes faster.</li>
          <li><strong>Fewer Errors:</strong> Predictable formatting reduces misinterpretations of data structure or types.</li>
          <li><strong>Higher Satisfaction:</strong> Tools that &quot;just work&quot; according to user expectations are more enjoyable.</li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          ...
          <li>Adding non-standard syntax elements (like comments, trailing commas in arrays/objects, which are invalid JSON).</li>
        </ul>
        <p>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          ...
          <li>Control indentation level (spaces vs. tabs, number of each) via user settings or common defaults (2 or 4 spaces).</li>
          ...
          <li>Ensure invalid JSON is handled gracefully, ideally with informative error messages that don&apos;t break the tool entirely.</li>
        </ul>
