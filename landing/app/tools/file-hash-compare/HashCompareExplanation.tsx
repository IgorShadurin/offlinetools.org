        ...
        <div>
          ...
          <ol className="list-decimal pl-6 space-y-3">
            <li>
              ...
              <p>Compare the hash of a downloaded installer or archive against the hash provided by the vendor to ensure the file is authentic and wasn&apos;t corrupted or tampered with.</p>
            </li>
            
            <li>
              <strong>Ensuring File Integrity After Transfer</strong>
              <p>Calculate a hash before transferring a large file (e.g., via FTP, USB drive), and verify it after the transfer to confirm no data corruption occurred.</p>
            </li>
            
            <li>
              <strong>Detecting File Tampering</strong>
              <p>Check if a critical file stored locally or on a server matches its original known hash to detect unauthorized modifications or malware infections.</p>
            </li>
            
            <li>
              <strong>Validating Backup Integrity</strong>
              <p>Compare the hash of a backup file (e.g., database dump, zip archive) against the hash of the original data source to ensure the backup is complete and uncorrupted.</p>
            </li>
            
            <li>
              <strong>Comparing ISO Images</strong>
              <p>Verify the integrity of downloaded operating system ISO images or other large disc images by comparing their hash against the official checksum.</p>
            </li>
            
            <li>
              <strong>Checking Configuration Consistency</strong>
              <p>Compare the hash of configuration files across different servers or environments to ensure they are identical.</p>
            </li>
            
            <li>
              <strong>Verifying Text Snippets</strong>
              <p>Ensure a piece of text (e.g., a public key, a code snippet, a license key) exactly matches an expected value by comparing hashes.</p>
            </li>
            
            <li>
              <strong>Auditing File Changes</strong>
              <p>Periodically calculate hashes of important files and compare them against previously recorded hashes to detect any changes over time.</p>
            </li>
            
            <li>
              <strong>Duplicate File Detection (Concept)</strong>
              <p>Use hash comparison as a primary method to identify potential duplicate files across directories or drives before performing slower byte-by-byte checks.</p>
            </li>
            
            <li>
              <strong>Confirming Data Synchronization</strong>
              <p>After syncing data between two locations (e.g., cloud storage, local folders), compare hashes of key files to confirm synchronization was successful.</p>
            </li>
          </ol>
        </div>
