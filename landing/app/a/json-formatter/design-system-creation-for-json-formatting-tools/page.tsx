    ...
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      <article className="prose prose-sm sm:prose lg:prose-lg xl:prose-xl mx-auto">
        ...
        <section className="space-y-6">
          <p>
            Building effective tools for developers, especially those dealing with data like JSON, requires more than just robust functionality. A well-designed user interface significantly enhances usability, reduces cognitive load, and builds user trust. This is where a <strong>Design System</strong> becomes invaluable.
          </p>
          <p>
          ...
          <ul className="list-disc pl-6 space-y-3 my-4">
            <li>
              <strong>Consistency:</strong> Ensures the same visual language and interaction patterns are used whether the user is formatting, validating, or comparing JSON. This reduces confusion and makes the tools intuitive.
            </li>
            <li>
              <strong>Efficiency:</strong> Developers and designers work faster by using pre-built, documented components instead of designing and coding from scratch every time.
            </li>
            <li>
              <strong>Scalability:</strong> As new features or tools are added, the design system provides a framework to maintain consistency without reinventing the wheel.
            </li>
            <li>
              <strong>Quality & Maintainability:</strong> Centralizing design decisions makes updates easier and reduces the likelihood of design drift or inconsistencies creeping in over time.
            </li>
            <li>
              <strong>User Experience:</strong> A predictable and coherent interface builds trust and makes the tools more pleasant and effective to use.
            </li>
          </ul>
          ...
          <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg my-4">
             ...
             <ul className="list-disc list-inside space-y-1 text-sm">
               <li><code>--color-json-key: #a77e10;</code> (e.g., a shade of brown/orange)</li>
               <li><code>--color-json-string: #067d17;</code> (e.g., a shade of green)</li>
               <li><code>--color-json-number: #1a0dad;</code> (e.g., a shade of blue)</li>
               <li><code>--color-json-boolean: #880080;</code> (e.g., a shade of purple)</li>
               <li><code>--color-json-null: #880080;</code> (e.g., same as boolean)</li>
               <li><code>--color-json-punctuation: #333;</code> (e.g., a dark grey)</li>
             </ul>
          ...
          <ul className="list-disc pl-6 space-y-3 my-4">
            <li>Styles for expansion/collapse toggles (e.g., arrows <ChevronRight /> / <ChevronDown />).</li>
...
.diff-changed span.highlight {
  ...
  border-radius: 2px;
          ...
          <p>
            Clearly define styles for primary, secondary, and tertiary buttons, including states (hover, active, disabled). Specific actions like &quot;Format&quot;, &quot;Validate&quot;, &quot;Copy&quot;, &quot;Clear&quot; should use consistent button styles. Icons (like <Copy /> for copy) should also have defined sizes and spacing relative to text.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-3 my-4">
            ...
            <li>Implementing dark mode/themes correctly (<MoonStar className="inline mx-0.5" />).</li>
          </ul>
          ...
          <ul className="list-disc pl-6 space-y-3 my-4">
            <li>Consistent visual treatment (color, icons like <CheckCheck className="inline mx-0.5 text-green-600"/> for success, <X className="inline mx-0.5 text-red-600"/> for errors).</li>
          ...
          <ul className="list-disc pl-6 space-y-3 my-4">
            <li>
              <BookOpenText className="inline mr-2 text-blue-400" /> Documentation: Create a central place (e.g., a dedicated website) documenting all components, principles, and usage guidelines. Show examples of components in different states.
            </li>
            <li>
