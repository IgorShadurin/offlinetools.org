    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="space-y-8 max-w-3xl mx-auto">
        <section className="space-y-4">
          ...
          <p>
            Building a robust JSON formatter is only part of the job. For developers to effectively
            use your tool, whether it&apos;s a command-line utility, a library, or a web interface,
            clear and comprehensive documentation is absolutely crucial. Good documentation reduces
            the barrier to entry, answers common questions, showcases features, and ultimately
            leads to better adoption and happier users.
          </p>
          <p>
            Effective documentation acts as a bridge between your formatter&apos;s capabilities and the
            developer&apos;s needs. It should explain not just <strong className="font-semibold">what</strong>
            the formatter does, but <strong className="font-semibold">how</strong> to use it for various
            scenarios and <strong className="font-semibold">why</strong> certain options exist.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <strong>Beginners:</strong> Might need more context on JSON itself, how to install and run basic commands, and simple examples.
            </li>
            <li>
              <strong>Experienced Developers:</strong> Will likely look for specific options, API details, performance considerations, and advanced features.
            </li>
            <li>
              <strong>Users of a Web Tool:</strong> Need instructions on pasting/uploading JSON, understanding output, and interpreting error messages within the UI.
            </li>
            <li>
              <strong>Users of a Library/API:</strong> Need detailed function/method signatures, return types, error handling specifics, and integration examples.
            </li>
          </ul>
          <p>
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              <strong>Basic Usage:</strong> The simplest way to use the tool with a minimal example. This is often the first thing developers look for.
            </li>
            <li>
              <strong>Key Features / Options:</strong> Detail the different formatting capabilities (indentation levels, sorting keys, preserving order, compact output, etc.). Explain each option clearly.
            </li>
            <li>
              <strong>Input &amp; Output:</strong> Explicitly state what kind of input the tool expects (e.g., valid JSON string, file path) and what format the output will be in.
            </li>
            <li>
              <strong>Error Handling &amp; Troubleshooting:</strong> Document common error messages (especially parsing errors) and explain what they mean and how to resolve them.
            </li>
            <li>
              <strong>Examples:</strong> Crucial for a formatter. Provide diverse examples demonstrating different features and use cases.
            </li>
            <li>
              <strong>API Reference (if applicable):</strong> Detailed documentation for programmatic access.
            </li>
            <li>
              <strong>Performance Considerations (optional but helpful):</strong> Notes on handling very large JSON files.
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <strong>Be Clear and Concise:</strong> Get straight to the point. Avoid jargon where possible, or explain it if necessary.
            </li>
            <li>
              <strong>Use Simple Language:</strong> Write in plain English.
            </li>
            <li>
              <strong>Be Accurate:</strong> Ensure all examples and descriptions match the tool&apos;s current functionality.
            </li>
            <li>
              <strong>Consistency:</strong> Use consistent terminology, formatting for code blocks, and structure.
            </li>
            <li>
              <strong>Focus on Use Cases:</strong> Instead of just listing options, explain what problem each option solves. For example, &quot;Use <code className="font-mono">--indent 4</code> to make the JSON readable with 4 spaces per level.&quot;
            </li>
            <li>
        ...
        <section className="space-y-4">
          ...
          <p>
            Examples are the most valuable part of formatter documentation. Show, don&apos;t just tell.
            Include:
          </p>
          <ul className="list-disc pl-6 space-y-2">
...
Expected comma or closing brace`}
            ...
            <p className="text-sm mt-2">
              <HelpCircle className="inline-block mr-1" size={16} /> Explain what the error means and how to fix it (e.g., &quot;The formatter found a string (&quot;age&quot;) where it expected a comma or the closing brace &apos;&#x7d;&apos; after the previous key-value pair.&quot;).
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>The option name (e.g., <code className="font-mono">--indent</code>, <code className="font-mono">sortKeys</code>).</li>
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <strong>Use Code Blocks Correctly:</strong> Use <code className="font-mono">&lt;pre&gt;&lt;code&gt;</code> tags for code, commands, input, and output. Specify the language if your documentation system supports highlighting (e.g., JSON, bash).
            </li>
            <li>
              <strong>Escape Special Characters:</strong> In code blocks or text describing syntax, use HTML entities for characters like <code className="font-mono">&lt;</code> (<code className="font-mono">&amp;lt;</code>), <code className="font-mono">&gt;</code> (<code className="font-mono">&amp;gt;</code>), <code className="font-mono">&#x7b;</code> (<code className="font-mono">&amp;#x7b;</code>), <code className="font-mono">&#x7d;</code> (<code className="font-mono">&amp;#x7d;</code>).
            </li>
            <li>
              <strong>Internal Linking:</strong> Link between related sections (e.g., link from an option description to a specific example).
            </li>
            <li>
              <strong>Add a Search Bar:</strong> If your documentation covers many topics, a search function is invaluable. (Mentioned as a feature, not implemented here).
            </li>
            <li>
              <strong>Feedback Mechanism:</strong> Provide a way for users to report issues or suggest improvements to the documentation itself. (Mentioned as a feature, not implemented here).
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              Provide examples of common errors (<XCircle className="inline-block mx-0.5 text-red-600 dark:text-red-400" size={16} /> missing comma, <XCircle className="inline-block mx-0.5 text-red-600 dark:text-red-400" size={16} /> unquoted keys, <XCircle className="inline-block mx-0.5 text-red-600 dark:text-red-400" size={16} /> invalid escape sequences) and show how the formatter reports them.
            </li>
            <li>
