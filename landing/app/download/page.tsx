        ...
        <Container>
                ...
                <Button size="lg" asChild>
                  <Link href={DOWNLOAD_LINKS[detectedPlatform]}>
                    <Download className="mr-2" /> Download for {
                      detectedPlatform === "mac_arm64" ? "macOS (Apple Silicon)" :
                      detectedPlatform === "mac_x64" ? "macOS (Intel)" :
                      detectedPlatform === "windows" ? "Windows" : "Linux"
                    }
                  </Link>
                </Button>
              </CardContent>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <Card className="md:col-span-2 lg:col-span-3">
              ...
              <CardContent className="flex flex-col items-center">
                <p className="text-center text-muted-foreground mb-4">
                  Portable AppImage for Linux distributions
                </p>
                <Button asChild>
            ...
            <div className="max-w-2xl mx-auto text-left space-y-6">
              ...
              <div>
                ...
                <ol className="list-decimal list-inside space-y-2 pl-4">
                  ...
                  <li>Windows SmartScreen may show a warning, click &ldquo;More info&rdquo; then &ldquo;Run anyway&rdquo;</li>
                </ol>
              </div>
              ...
              <div>
                ...
                <ol className="list-decimal list-inside space-y-2 pl-4">
                  ...
                  <li>Make the AppImage executable with: <code>chmod +x desktop_x86_64.AppImage</code></li>
                  <li>Run the application with: <code>./desktop_x86_64.AppImage</code></li>
                </ol>
              </div>
            </div>
          </div>
