              ...
              {isProcessed && base64Output && (
                <div className="space-y-4">
                  ...
                  <textarea
                    ref={textAreaRef}
                    id="base64-output"
                    className="w-full min-h-[200px] p-3 font-mono text-sm border rounded-md focus:outline-none focus:ring-2 focus:ring-primary"
                    readOnly
                    value={base64Output}
                  />
                </div>
                ...
                <div className="space-y-4">
                  <div className="border rounded-md p-4 bg-gray-50 dark:bg-gray-900">
                    <div className="flex flex-wrap gap-2 justify-between items-center">
                      <div>
                        <h3 className="font-medium">Decoded Binary Data</h3>
                        <p className="text-sm text-muted-foreground">
                          {formatSize(binaryData.length)}
                        </p>
                      </div>
                      <Button
                        variant="secondary"
