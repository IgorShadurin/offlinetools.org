  ...
  return (
    <div className="p-6 border rounded-lg bg-card text-card-foreground shadow-sm space-y-6">
      ...
      <div className="space-y-4">
        ...
        <p>
          The UUID Generator creates universally unique identifiers following the RFC4122 standard. UUIDs are 128-bit
          identifiers that are guaranteed to be unique across space and time, making them ideal for distributed systems
      ...
      <div className="space-y-4">
        ...
        <ol className="list-decimal pl-6 space-y-4">
          <li>
            ...
            <p>
              UUIDs are commonly used as primary keys in databases, especially in distributed systems where multiple
              servers might be generating IDs simultaneously.
            </p>
          </li>
          <li>
            <strong>Distributed Systems</strong>
            <p>
              In microservices architectures, UUIDs help track requests and entities across multiple services without
              coordination.
            </p>
          </li>
          <li>
            ...
            <p>
              UUIDs can be used to uniquely identify content or resources in content management systems and file
              storage.
            </p>
          </li>
          <li>
          ...
          <li>
            ...
            <p>
              Hardware devices can be assigned UUIDs during manufacturing to ensure each device has a globally unique
              identifier.
            </p>
          </li>
          <li>
            ...
            <p>
              When creating temporary files, UUIDs ensure no filename collisions occur even in high-concurrency
              environments.
            </p>
          </li>
          <li>
      ...
      <div className="space-y-4">
        ...
        <p>This tool implements all standard UUID versions defined in RFC9562:</p>
        <ul className="list-disc pl-6 space-y-2">
          <li>
          ...
          <li>
            <strong>Version 4 (Random)</strong>: Uses random numbers to generate a UUID. Most commonly used version due
            to its simplicity and privacy.
          </li>
          <li>
        ...
        <p>The tool also supports special UUIDs:</p>
        <ul className="list-disc pl-6 space-y-2">
          <li>
        ...
        <p>
          The implementation uses the official uuid npm package, which provides high-quality, standards-compliant UUID
          generation.
        </p>
      </div>
    </div>
