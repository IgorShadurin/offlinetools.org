...
export const metadata = {
  ...
  description:
    "Learn about the Offline Tools platform, our mission, values, and the team behind our privacy-focused tools.",
};
    ...
    <PageLayout>
      <Container className="py-12 md:py-16">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-4 text-muted-foreground md:text-lg">Building privacy-focused tools for a better internet</p>
        </div>
        ...
        <div className="mx-auto max-w-3xl mt-10 md:mt-16 space-y-10">
          <section className="space-y-4">
            ...
            <p>
              ...
              high-quality utilities that work entirely offline, ensuring your data never leaves your device without
              your consent.
            </p>
            <p>
              We&apos;re committed to building tools that respect user privacy while delivering exceptional
          ...
          <section className="space-y-4">
            ...
            <p>
              Offline Tools was founded in 2023 by a group of privacy advocates and developers who were frustrated with
              the increasing number of online services that collected and monetized user data.
            </p>
            <p>
              What started as a small collection of utilities has grown into a comprehensive platform of privacy-focused
              tools used by thousands of people daily.
            </p>
          </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">
                  We&apos;re committed to building tools that are reliable and effective.
                </p>
              </div>
            </div>
          </section>
