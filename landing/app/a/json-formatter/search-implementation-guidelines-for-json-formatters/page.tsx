  ...
  return (
    <>
      ...
      <div className="space-y-6">
        <p>
          Searching within a large JSON document can be a crucial feature for any JSON formatter or editor. As
          JSON data grows in complexity and size, simply browsing is no longer sufficient. Implementing robust
          and user-friendly search functionality is essential for users to quickly locate specific data points,
          keys, or values.
        </p>

        <h2 className="text-2xl font-semibold mt-8">Why Search is Important</h2>
        <p>
          JSON documents are tree-like structures. Finding specific information can involve traversing nested
          objects and arrays. A well-implemented search feature bypasses the need for manual navigation, saving
          significant time and effort for developers and data analysts.
        </p>
        ...
        <p>
          Basic text search is a starting point, but more advanced search capabilities can greatly enhance the
          utility of a JSON formatter.
        </p>
        ...
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-6 space-y-4">
          <div>
            ...
            <p className="text-sm">
              Searches for a literal string anywhere in the formatted text representation of the JSON. This
              is the simplest form and should ideally offer case-sensitive and case-insensitive options.
            </p>
          </div>
          <div>
            <h3 className="text-lg font-medium">2. Key Search</h3>
            <p className="text-sm">
              Allows searching specifically for property names (keys) within objects. Useful for finding
              where a particular configuration setting or data field is defined.
            </p>
          </div>
          <div>
            <h3 className="text-lg font-medium">3. Value Search</h3>
            <p className="text-sm">
              Focuses the search only within the values associated with keys. This can be useful for finding
              specific data entries like IDs, names, or status codes.
            </p>
          </div>
          <div>
            <h3 className="text-lg font-medium">4. Key-Value Pair Search</h3>
            <p className="text-sm">
              Searches for occurrences where a specific key is associated with a specific value (e.g.,
              finding all objects where <code>"status"</code> is <code>"active"</code>).
            </p>
          </div>
          <div>
            ...
            <p className="text-sm">
              ...
              <code>/users/0/address/city</code>). This is more advanced and requires understanding JSON
              path syntax.
            </p>
          </div>
          <div>
            ...
            <p className="text-sm">
              Provides powerful pattern matching capabilities across the JSON text. This is flexible but
              requires users familiar with regex syntax.
            </p>
          </div>
        </div>
        ...
        <ul className="list-disc pl-6 space-y-3 my-4">
          ...
          <p className="text-sm -mt-2">
            Searching large strings or complex structures can be slow. Consider optimizing search algorithms,
            especially for basic text search, potentially using string searching algorithms like Boyer-Moore or
            Rabin-Karp.
          </p>
          <li className="font-medium">Large File Handling:</li>
          <p className="text-sm -mt-2">
            For very large files that cannot fit entirely into memory, consider streaming parsing or indexing
            techniques if the search needs to be fast. However, for typical browser-based formatters, loading the
            content is usually the first step.
          </p>
          ...
          <p className="text-sm -mt-2">
            Visually indicating all search matches within the formatted JSON is crucial for usability. This
            requires tracking the original positions of the matched text.
          </p>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-3 my-4">
          ...
          <li>
            <span className="font-medium">Navigation Buttons:</span> &quot;Find Next&quot; and &quot;Find
            Previous&quot; buttons to cycle through matches.
          </li>
          <li>
        ...
        <p>
          While a full implementation is complex, here&apos;s a simplified conceptual view of how basic text
          search might work on the string representation of formatted JSON:
        </p>
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
...
// These indices are then used to apply highlighting in the UI.`}
        ...
        <p>
          Building upon search, a &quot;Find and Replace&quot; feature allows users not just to find data but
          also to modify it. This is particularly useful for bulk updates or corrections within the JSON structure.
        </p>
        <p>
          Implementation of replace requires more care, ensuring that the replacement doesn&apos;t break the JSON
          syntax, especially when dealing with complex replacements or regular expressions. Offering options to
          replace one instance or all instances is standard.
        </p>
        ...
        <p>
          Search is a fundamental feature that transforms a static JSON formatter into a dynamic and productive
          tool. By considering different search types, optimizing performance, and designing a user-friendly
          interface, you can enable users to interact with and understand their JSON data much more effectively.
          Investing time in a robust search implementation will significantly enhance the value of your JSON
          formatter.
        </p>
      </div>
    </>
