...
const faqData = [
  {
    ...
    answer: "Offline Tools is a platform that provides a suite of utilities designed to work entirely offline, respecting your privacy and ensuring that your data never leaves your device."
  },
  {
  ...
  },
  {
    ...
    answer: "We offer a range of both free and premium tools. Our basic utilities are free for everyone to use, while some advanced features may require a subscription. Please check our pricing page for more details."
  },
  {
    question: "How do I suggest a new tool?",
    answer: "We welcome suggestions for new tools! Please visit our contact page and share your ideas with us. We regularly evaluate user suggestions for our development roadmap."
  },
  {
    question: "Can I use Offline Tools for commercial purposes?",
    answer: "Yes, you can use our tools for both personal and commercial purposes. Please refer to our Terms of Service for detailed usage policies."
  },
  {
    question: "How do I report a bug?",
    answer: "If you encounter any issues while using our tools, please visit our contact page to report the bug. Please include as much detail as possible to help us reproduce and fix the issue quickly."
  }
];
