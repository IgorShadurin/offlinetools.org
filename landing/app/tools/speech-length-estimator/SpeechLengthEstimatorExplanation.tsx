  ...
  return (
    <div className="p-6 border rounded-lg bg-card text-card-foreground shadow-sm space-y-6">
      ...
      <div className="space-y-3">
        ...
        <p>
          The Speech Length Estimator calculates how long it would take to speak a piece of text aloud. 
          It provides an estimate based on the number of words and optional punctuation pauses, with adjustable speaking rates.
        </p>
      ...
      <div className="space-y-3">
        ...
        <ol className="list-decimal pl-6 space-y-3">
          <li>
            ...
            <p>Estimate how long your speech or presentation will take to deliver, helping you prepare properly for time-limited speaking opportunities.</p>
          </li>
          <li>
            <strong>Content Creation</strong>
            <p>Determine the length of scripts for videos, podcasts, or other audio content to meet specific duration requirements.</p>
          </li>
          <li>
            <strong>Academic Presentations</strong>
            <p>Check if your academic paper or presentation fits within allocated time slots for conferences or classroom presentations.</p>
          </li>
          <li>
          ...
          <li>
            ...
            <p>Compare your actual speaking time against the estimated time to determine if you're speaking at an appropriate pace.</p>
          </li>
          <li>
      ...
      <div className="space-y-3">
        ...
        <p>
          The Speech Length Estimator uses the following approach to calculate speaking time:
        </p>
        <ul className="list-disc pl-6 space-y-1">
          ...
          <li>The default speaking rates are based on research of average reading speeds:
          ...
          <li>The calculation assumes English language text (other languages may have different natural speaking rates)</li>
        </ul>
        <p className="mt-3">
          All processing is done entirely in your browser - no text is sent to any server, ensuring privacy for sensitive content.
        </p>
      </div>
    </div>
  );
