...
export default function UnderstandingJsonSpecArticle() {
  return (
    <>
      ...
      <div className="space-y-6">
        ...
        <p>
          ECMA-404, formally titled &quot;The JSON Data Interchange Format&quot;, is a technical standard published
          by Ecma International. It provides a concise and precise definition of the JSON syntax, ensuring that
          JSON data can be reliably parsed and generated across different programming languages and systems.
        </p>
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
          ...
          <ul className="list-disc pl-6 space-y-2 mt-2">
            ...
            <li>The set of allowed primitive values (strings, numbers, boolean literals `true`, `false`, and `null`).</li>
        ...
        <p>
          ...
          &quot;JSON-like&quot; data), strictly following ECMA-404 ensures maximum compatibility and prevents
        ...
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
          ...
          <ul className="list-disc pl-6 space-y-2 mt-2">
            <li>
              <span className="font-medium">Interoperability:</span> Data produced according to the spec can be reliably consumed by any spec-compliant parser.
            </li>
            <li>
              <span className="font-medium">Predictability:</span> You know exactly how your data will be interpreted.
            </li>
            <li>
              <span className="font-medium">Error Prevention:</span> Avoids subtle bugs caused by parsers handling non-standard syntax differently.
            </li>
            <li>
              <span className="font-medium">Security:</span> Lenient parsers can sometimes be exploited. Strict parsing is generally safer.
            </li>
          </ul>
        </div>
        ...
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
          ...
          <ul className="list-disc pl-6 space-y-2 mt-2">
            <li>Starts with an opening curly brace {`{`} and ends with a closing curly brace {`}`}.</li>
            ...
            <li>Values can be a string, number, object, array, boolean ({`true`} or {`false`}), or {`null`}.</li>
            <li>Whitespace can appear before or after {`{`} {`}`}, {`,`} and {`:`}.</li>
          </ul>
  ...
  "spouse": null
        ...
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
          <h4 className="text-lg font-medium">Syntax Rules:</h4>
          <ul className="list-disc pl-6 space-y-2 mt-2">
            <li>Starts with an opening square bracket {`[`} and ends with a closing square bracket {`]`}.</li>
  ...
  null
        ...
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
          <ul className="list-disc pl-6 space-y-2 mt-2">
            <li>
              <span className="font-medium">string:</span> A sequence of zero or more Unicode characters, enclosed in double quotes. Specific characters (like double quote, backslash, control characters) must be escaped using a backslash {`\\`}.
            </li>
            <li>
              <span className="font-medium">number:</span> A double-precision floating-point number in the IEEE 754 standard. Includes integers, decimals, and optionally an exponent. Does *not* include {`NaN`} or {`Infinity`}.
            </li>
            <li>
        ...
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
          <h3 className="text-lg font-medium text-red-600 dark:text-red-400">What is NOT valid JSON according to ECMA-404:</h3>
          <ul className="list-disc pl-6 space-y-3 mt-2">
            <li>
              <span className="font-medium">Comments:</span> Single-line (`//`) or multi-line (`/* ... */`) comments are not allowed.
  ...
  "value": 123
            ...
            <li>
              <span className="font-medium">Trailing Commas:</span> A comma after the last element in an object or array is not allowed.
              <div className="bg-white p-3 rounded dark:bg-gray-900 overflow-x-auto mt-2">
                <pre>
                  {`{
  "item1": 1,
  "item2": 2, // Trailing comma invalid
            ...
            <li>
              <span className="font-medium">Single Quotes:</span> Both keys and string values must be enclosed in double quotes `"` NOT single quotes `'`.
              <div className="bg-white p-3 rounded dark:bg-gray-900 overflow-x-auto mt-2">
                <pre>
                  {`{
  ...
  name: "David" // Unquoted key invalid
            ...
            <li>
              <span className="font-medium">Undefined or NaN/Infinity:</span> These JavaScript specific values are not valid JSON numbers or literals. Only `null`, `true`, `false` are allowed literals beyond strings and numbers.
              <div className="bg-white p-3 rounded dark:bg-gray-900 overflow-x-auto mt-2">
                <pre>
                  {`{
  ...
  "value3": Infinity   // Invalid
        ...
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
          <ul className="list-disc pl-6 space-y-3 mt-2">
            <li>
              <span className="font-medium">Online JSON Validators:</span> Many websites provide tools to paste your JSON and check its validity against the standard.
            </li>
            <li>
              <span className="font-medium">Programming Language Parsers:</span> Standard JSON parsing libraries in most languages (e.g., Python&apos;s `json`, JavaScript&apos;s `JSON.parse`) are designed to be spec-compliant and will throw errors on invalid JSON.
            </li>
            <li>
              <span className="font-medium">Command-line Tools:</span> Utilities like `jq` or others specifically designed for JSON manipulation and validation can check syntax.
            </li>
            <li>
              <span className="font-medium">IDEs and Text Editors:</span> Many modern editors have built-in JSON syntax highlighting and validation based on the standard.
            </li>
          </ul>
        </div>
        ...
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
          <ul className="list-disc pl-6 space-y-2 mt-2">
            <li>
              <span className="font-medium">ECMA-404:</span> Defines the *syntax* of a valid JSON document. It tells you *if* a string of text is structurally correct JSON.
            </li>
            <li>
              <span className="font-medium">JSON Schema:</span> Defines the *structure and data types* of a JSON document. It tells you *if* a valid JSON document conforms to a specific model or contract (e.g., &quot;this object must have a key &apos;age&apos; whose value is an integer&quot;).
            </li>
          </ul>
          <p className="mt-2">
