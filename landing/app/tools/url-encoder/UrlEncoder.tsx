    ...
    <>
      <Container className="py-8 md:py-12">
        ...
        <div className="space-y-4">
          {/* Tabs */}
          <Tabs defaultValue="encode" value={activeTab} onValueChange={handleTabChange} className="w-full">
          ...
          <div className="flex flex-wrap md:flex-nowrap gap-8">
            ...
            <div className="w-full md:w-1/2 flex items-center justify-between flex-wrap gap-2">
              <Label htmlFor="input-text">{activeTab === "encode" ? "Text to Encode" : "Text to Decode"}</Label>
            ...
            <div className="w-full md:w-1/2 flex items-center justify-between h-9">
              <Label htmlFor="output-text">{activeTab === "encode" ? "Encoded URL" : "Decoded Text"}</Label>
          ...
          <div className="flex flex-wrap md:flex-nowrap gap-8">
            ...
            <div className="w-full md:w-1/2">
              <Textarea
                ...
                placeholder={activeTab === "encode" ? "Enter text to encode..." : "Enter encoded text to decode..."}
                value={inputText}
            ...
            <div className="w-full md:w-1/2">
              {error ? (
                ...
                <Textarea
                  ...
                  className="min-h-[250px] font-mono w-full"
                  placeholder={
                    activeTab === "encode" ? "Encoded URL will appear here..." : "Decoded text will appear here..."
                  }
                  value={outputText}
                  readOnly
                />
