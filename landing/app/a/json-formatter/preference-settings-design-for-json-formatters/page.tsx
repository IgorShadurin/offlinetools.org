...
import { Cog, Code, LayoutList, Palette, ZoomIn, ZoomOut, CheckSquare, Square, Diff, AlignLeft, ListTree } from "lucide-react";
    ...
    <>
      ...
      <div className="space-y-6 text-gray-800 dark:text-gray-200">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li><strong>Readability:</strong> Users can choose indentation and spacing that feels most comfortable to them.</li>
          <li><strong>Consistency:</strong> Enforce a specific style across a codebase or team.</li>
          <li><strong>Tool Integration:</strong> Match the output format of other tools or language-specific formatters.</li>
          <li><strong>Diff Friendliness:</strong> Choose settings that minimize changes when comparing different versions of JSON files (e.g., consistent key ordering).</li>
          <li><strong>Compactness:</strong> Generate minimal output for storage or transmission when readability isn't the primary goal.</li>
        </ul>
    ...
    "key": {
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            ...
            <p>Determines if a space should follow a comma (e.g., <code>1, 2</code> vs. <code>1,2</code>).</p>
            <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
...
{`[1,2,3]`}
          ...
          <li>
            ...
            <p>
              Controls spacing around the colon in key-value pairs (e.g., <code>"key": "value"</code> vs. <code>"key":"value"</code>). Common styles include <code>": "</code> (space after) or <code>" : "</code> (space around).
            </p>
            <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
...
{`{
  ...
  "age":30
          ...
          <li>
            ...
            <p>
              Whether to include spaces immediately inside opening brackets <code>[</code>, closing brackets <code>]</code>, opening braces <code>&#x7b;</code>, and closing braces <code>&#x7d;</code> (e.g., <code>[ 1, 2 ]</code> vs. <code>[1, 2]</code>).
            </p>
             <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
...
{`[1, 2, 3]`}
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            ...
            <p>Option to add an extra empty line after a closing brace <code>&#x7d;</code> or bracket <code>]</code>, particularly at the top level or between distinct objects in an array, though this is less common for standard JSON formatting.</p>
          </li>
           <li>
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            ...
            <ul className="list-circle pl-6 mt-1 space-y-1">
              <li><CheckSquare size={16} className="inline-block mr-1 text-green-500" /> <strong>Alphabetical:</strong> Sort keys lexicographically. This is the most common and useful option for consistency.</li>
              <li><Square size={16} className="inline-block mr-1 text-blue-500" /> <strong>Original:</strong> Preserve the order of keys from the input JSON string. Useful when the order might carry semantic meaning (though technically it shouldn't in pure JSON).</li>
              <li><Square size={16} className="inline-block mr-1 text-yellow-500" /> <strong>Custom:</strong> Allow specifying a custom order for certain keys, placing others alphabetically at the end. (More advanced).</li>
            </ul>
            <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
  ...
  "b": 2
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
             ...
             <p>Removes all non-essential whitespace (spaces, newlines) to produce the smallest possible output string. Useful for network transmission or storage.</p>
             <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
...
{`{
  ...
  "data": [
    ...
    3
           ...
           <li>
             <strong>Specific Compactness Rules:</strong> More granular options might allow compacting empty objects/arrays (<code>&#x7b;&#x7d;</code>, <code>[]</code>) or simple key-value pairs onto a single line, even in pretty mode.
             <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
...
{`{
  ...
  "config": {}
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            <strong>Grouping:</strong> Organize settings logically into collapsible sections or tabs (e.g., General, Indentation, Spacing, Advanced).
          </li>
          <li>
            <strong>Clear Labels and Descriptions:</strong> Use straightforward language. Briefly explain what each setting does, perhaps with a small example.
          </li>
          <li>
            <strong>Sensible Defaults:</strong> Choose defaults that match common conventions (e.g., 2 or 4 spaces, space after colon/comma).
          </li>
          <li>
            <strong>Live Preview:</strong> The most helpful feature is a live preview area that updates the formatted output as the user changes settings. This provides immediate feedback.
          </li>
          <li>
            <strong>Import/Export Settings:</strong> Allow users to save and share their preferred configurations.
          </li>
          <li>
            <strong>Integration with Configuration Files:</strong> For developer tools, consider supporting standard configuration file formats (like <code>.editorconfig</code> or specific formatter configs) to integrate with existing project setups.
          </li>
        </ul>
