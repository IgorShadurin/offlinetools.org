    ...
    <>
      ...
      <div className="space-y-6 text-lg">
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li><strong>Moving to Keys/Properties:</strong> Commands like "<code className="font-mono text-sm bg-gray-100 dark:bg-gray-800 px-1 rounded">&#x22;Go to user&quot;</code>", "<code className="font-mono text-sm bg-gray-100 dark:bg-gray-800 px-1 rounded">&#x22;Select name&quot;</code>", "<code className="font-mono text-sm bg-gray-100 dark:bg-gray-800 px-1 rounded">&#x22;Focus on address&quot;</code>". The system needs to identify the target key. This requires understanding the current context (the current object).</li>
          <li><strong>Entering Arrays/Objects:</strong> Commands like "<code className="font-mono text-sm bg-gray-100 dark:bg-gray-800 px-1 rounded">&#x22;Enter array&quot;</code>", "<code className="font-mono text-sm bg-gray-100 dark:bg-gray-800 px-1 rounded">&#x22;Open object&quot;</code>".</li>
          <li><strong>Navigating within Arrays:</strong> Commands like "<code className="font-mono text-sm bg-gray-100 dark:bg-gray-800 px-1 rounded">&#x22;Next item&quot;</code>", "<code className="font-mono text-sm bg-gray-100 dark:bg-gray-800 px-1 rounded">&#x22;Previous item&quot;</code>", "<code className="font-mono text-sm bg-gray-100 dark:bg-gray-800 px-1 rounded">&#x22;Go to item three&quot;</code>". Index-based or positional navigation is key here.</li>
          <li><strong>Going Up/Back:</strong> Commands like "<code className="font-mono text-sm bg-gray-100 dark:bg-gray-800 px-1 rounded">&#x22;Go back&quot;</code>", "<code className="font-mono text-sm bg-gray-100 dark:bg-gray-800 px-1 rounded">&#x22;Parent object&quot;</code>". This requires maintaining a navigation history or stack.</li>
          <li><strong>Root Navigation:</strong> Commands like "<code className="font-mono text-sm bg-gray-100 dark:bg-gray-800 px-1 rounded">&#x22;Go to root&quot;</code>".</li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li><strong>Changing Values:</strong> Commands like "<code className="font-mono text-sm bg-gray-100 dark:bg-gray-800 px-1 rounded">&#x22;Change value to 'New York'&quot;</code>", "<code className="font-mono text-sm bg-gray-100 dark:bg-gray-800 px-1 rounded">&#x22;Set age to 35&quot;</code>", "<code className="font-mono text-sm bg-gray-100 dark:bg-gray-800 px-1 rounded">&#x22;Make it true&quot;</code>". The system needs to parse the target value, respecting JSON data types (string, number, boolean, null).</li>
          <li><strong>Adding Key-Value Pairs (Objects):</strong> Commands like "<code className="font-mono text-sm bg-gray-100 dark:bg-gray-800 px-1 rounded">&#x22;Add key 'city' with value 'London'&quot;</code>".</li>
          <li><strong>Adding Items (Arrays):</strong> Commands like "<code className="font-mono text-sm bg-gray-100 dark:bg-gray-800 px-1 rounded">&#x22;Add item 'apple'&quot;</code>", "<code className="font-mono text-sm bg-gray-100 dark:bg-gray-800 px-1 rounded">&#x22;Insert value 10 at index zero&quot;</code>".</li>
          <li><strong>Deleting:</strong> Commands like "<code className="font-mono text-sm bg-gray-100 dark:bg-gray-800 px-1 rounded">&#x22;Delete this key&quot;</code>" (if currently on a key-value pair), "<code className="font-mono text-sm bg-gray-100 dark:bg-gray-800 px-1 rounded">&#x22;Delete item four&quot;</code>" (if in an array), "<code className="font-mono text-sm bg-gray-100 dark:bg-gray-800 px-1 rounded">&#x22;Remove the address block&quot;</code>" (if on an object/array value).</li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li><strong>Current Location:</strong> Announce the current key, index, or value ("Now at key 'name'").</li>
          <li><strong>Action Success:</strong> Confirm that a command was understood and executed ("Changed name to Bob", "Deleted item three").</li>
          <li><strong>Ambiguity or Error:</strong> Inform the user if the command was unclear or failed ("Couldn't find key 'usser'", "Which user do you mean?").</li>
          <li><Speaker className="inline-block mr-1" size={20} /> Text-to-Speech (TTS) is essential for providing this feedback.</li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li><strong>Intent:</strong> Is the user trying to navigate, edit, add, or delete?</li>
          <li><strong>Target:</strong> Which part of the JSON is the command referring to (a specific key, an index, the current location)?</li>
          <li><strong>Value/Data:</strong> If editing, what is the new value or key/value pair?</li>
        </ul>
        <p>
        ...
        <p>
          The system needs to know "where" the user is within the JSON structure. This can be managed with a "voice cursor" or path similar to a file system path (e.g., <code className="font-mono text-sm bg-gray-100 dark:bg-gray-800 px-1 rounded">/users/[2]/address/city</code>). Commands operate relative to this current context.
        </p>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li><strong>Confirmation:</strong> Asking the user to confirm the target if ambiguous ("Did you mean the 'name' in the first object or the second?").</li>
          <li><strong>Path Specification:</strong> Allowing users to specify a more explicit path ("Go to users item one name").</li>
          <li><strong>Number Spelling:</strong> Potentially requiring numbers to be spelled out or using a limited numerical vocabulary.</li>
        </ul>
...
`}
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li><strong>Client-side:</strong> Pros: Low latency, no server cost for processing. Cons: Limited STT/NLU capabilities depending on browser support, potential privacy concerns if sensitive data is involved.</li>
          <li><strong>Server-side:</strong> Pros: Access to powerful STT/NLU services, handles complex logic, centralized data handling. Cons: Higher latency, server costs, requires sending audio/text over network.</li>
          <li><strong>Hybrid:</strong> Perform simple commands/navigation client-side and complex edits/searches server-side.</li>
        </ul>
