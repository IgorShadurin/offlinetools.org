...
export const metadata: Metadata = {
  ...
  description: "Learn how to manage configuration across development, staging, and production environments using JSON property inheritance.",
};
...
export default function JsonPropertyInheritanceArticle() {
  ...
  "features": {
    ...
    "darkMode": true
        ...
        <ol className="list-decimal pl-6 space-y-2 my-4">
          ...
          <li>
            <strong>Environment-Specific Configuration:</strong> Contains only the settings that are different or new for a particular environment.
          </li>
          <li>
            <strong>Merging Process:</strong> At application startup or build time, the environment-specific configuration is merged on top of the base configuration. Properties in the environment file overwrite properties in the base file if they exist in both. New properties in the environment file are added.
          </li>
        </ol>
  ...
  "devSpecificSetting": "This setting only exists in development"   // Added
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            <strong>Primitive Types (strings, numbers, booleans, null):</strong> The value in the environment file simply replaces the value in the base file.
          </li>
          <li>
            <strong>Objects:</strong> Deep merge is usually the desired behavior, merging properties from the environment object into the base object.
          </li>
          <li>
            <strong>Arrays:</strong> This is where it gets tricky and depends on your needs. Common strategies include:
            <ul className="list-circle pl-6 mt-2 space-y-1">
              <li>
                <strong>Replace:</strong> The array in the environment file completely replaces the array in the base file.
              </li>
              <li>
                <strong>Concatenate:</strong> Elements from the environment array are appended to the elements from the base array.
              </li>
              <li>
                <strong>Merge by Key:</strong> If the array contains objects with unique identifiers (like an `id` or `name` property), merge objects with matching keys and add non-matching ones. This is complex and less common for simple config.
              </li>
            </ul>
            <p>
...
`}
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            <strong>DRY (Don&apos;t Repeat Yourself):</strong> Reduces redundancy by keeping common settings in one place.
          </li>
          <li>
          ...
          <li>
            <strong>Readability:</strong> Environment-specific files are smaller and show only the differences, making it clear what changes between stages.
          </li>
          <li>
            <strong>Reduced Errors:</strong> Less copy-pasting means fewer chances of introducing typos or inconsistencies.
          </li>
          <li>
            <strong>Version Control Friendly:</strong> Changes to configuration are explicit in smaller, difference-focused files.
          </li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            <strong>Requires Merge Logic:</strong> You need a process (tooling or code) to perform the merge before the configuration can be used.
          </li>
          <li>
            <strong>Complexity with Arrays:</strong> Deciding and implementing the array merge strategy can add complexity.
          </li>
          <li>
            <strong>Debugging:</strong> Sometimes tracking down the final value of a deeply nested property requires looking at multiple files and understanding the merge order.
          </li>
          <li>
            <strong>Sensitive Data:</strong> Passwords and API keys should ideally not be stored directly in these files, especially if they are committed to public repositories. Environment variables or secrets management systems are better suited for sensitive data, potentially overriding values from the JSON merge.
          </li>
        </ul>
