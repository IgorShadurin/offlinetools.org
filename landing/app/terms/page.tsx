        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-10 md:mt-16 space-y-8 prose dark:prose-invert max-w-none">
            <section>
              ...
              <p>
                By accessing or using Offline Tools (&quot;the Service&quot;), you agree to be bound by these Terms of
            ...
            <section>
              ...
              <p>
                Offline Tools provides a set of browser-based utilities designed to operate offline, allowing users to
                process data locally without transmitting information to external servers.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                The Service and its original content, features, and functionality are owned by Offline Tools and are
            ...
            <section>
              ...
              <p>
                ...
                operate offline, your User Content is processed locally on your device and is not transmitted to our
            ...
            <section>
              ...
              <p>
                ...
                either express or implied. We do not warrant that the Service will be uninterrupted or error-free, that
            ...
            <section>
              ...
              <p>
                In no event shall Offline Tools be liable for any indirect, incidental, special, consequential, or
            ...
            <section>
              ...
              <p>
                These Terms shall be governed by and defined following the laws of [Your Jurisdiction]. Offline Tools
                and yourself irrevocably consent that the courts of [Your Jurisdiction] shall have exclusive
