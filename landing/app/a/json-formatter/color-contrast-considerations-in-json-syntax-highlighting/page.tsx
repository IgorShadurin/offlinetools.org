  ...
  return (
    <>
      ...
      <div className="space-y-6">
        <p>
          Syntax highlighting is a crucial feature in code editors, IDEs, and documentation pages. It uses different
          colors to visually distinguish elements of code, making it easier to read and understand JSON data. However,
          poor color contrast can make highlighted JSON difficult or impossible to read for many users, particularly
          those with visual impairments.
        </p>

        <h2 className="text-2xl font-semibold mt-8">Why Color Contrast Matters</h2>
        <p>
          Color contrast refers to the difference in luminance or color that makes text distinguishable from its
          background. In the context of syntax highlighting, contrast affects how easily users can read and
          differentiate various JSON elements.
        </p>
            ...
            <tbody>
              <tr className="border-t">
                ...
                <td className="px-4 py-2">
                  Users with visual impairments, color blindness, or low vision can read and understand code
                </td>
              </tr>
              <tr className="border-t">
        ...
        <p>
          The Web Content Accessibility Guidelines (WCAG) provide specific standards for color contrast ratios. While
          these guidelines were designed for web content, they apply equally well to code editors and syntax
          highlighting.
        </p>
        ...
        <p>
          Understanding how different JSON elements are typically highlighted can help designers and developers create
          more accessible syntax highlighting schemes.
        </p>
        ...
        <p>This example shows JSON with colors that provide good contrast against a light background:</p>
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
          <div className="bg-white p-4 rounded dark:bg-gray-900 overflow-x-auto">
            <pre className="text-sm">
              <code>
                <span className="text-gray-800">&#123;</span>
                <br /> <span className="text-red-700">&quot;name&quot;</span>
                <span className="text-gray-800">:</span> <span className="text-green-700">&quot;Alice&quot;</span>
                <span className="text-gray-800">,</span>
                <br /> <span className="text-red-700">&quot;age&quot;</span>
                <span className="text-gray-800">:</span> <span className="text-blue-700">30</span>
                <span className="text-gray-800">,</span>
                <br /> <span className="text-red-700">&quot;isStudent&quot;</span>
                <span className="text-gray-800">:</span> <span className="text-cyan-700">false</span>
                <span className="text-gray-800">,</span>
                <br /> <span className="text-red-700">&quot;courses&quot;</span>
                <span className="text-gray-800">:</span> <span className="text-gray-800">[</span>
                <br /> <span className="text-green-700">&quot;Math&quot;</span>
                <span className="text-gray-800">,</span>
                <br /> <span className="text-green-700">&quot;Science&quot;</span>
                <span className="text-gray-800">,</span>
          ...
          <p className="mt-2 text-sm">
            The colors above have strong contrast with the white background, making all elements easily readable. Dark
            red for keys, dark green for strings, blue for numbers, and dark gray for structural elements all provide
            contrast ratios above the WCAG AA minimum of 4.5:1.
          </p>
        </div>

        <h3 className="text-xl font-medium mt-6">Poor Contrast - Light Theme</h3>
        <p>This example shows JSON with colors that provide poor contrast against a light background:</p>
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
          <div className="bg-white p-4 rounded dark:bg-gray-900 overflow-x-auto">
            <pre className="text-sm">
              <code>
                <span className="text-gray-300">&#123;</span>
                <br /> <span className="text-red-300">&quot;name&quot;</span>
                <span className="text-gray-300">:</span> <span className="text-green-300">&quot;Alice&quot;</span>
                <span className="text-gray-300">,</span>
                <br /> <span className="text-red-300">&quot;age&quot;</span>
                <span className="text-gray-300">:</span> <span className="text-blue-300">30</span>
                <span className="text-gray-300">,</span>
                <br /> <span className="text-red-300">&quot;isStudent&quot;</span>
                <span className="text-gray-300">:</span> <span className="text-cyan-300">false</span>
                <span className="text-gray-300">,</span>
                <br /> <span className="text-red-300">&quot;courses&quot;</span>
                <span className="text-gray-300">:</span> <span className="text-gray-300">[</span>
                <br /> <span className="text-green-300">&quot;Math&quot;</span>
                <span className="text-gray-300">,</span>
                <br /> <span className="text-green-300">&quot;Science&quot;</span>
                <span className="text-gray-300">,</span>
          ...
          <p className="mt-2 text-sm">
            The light colors above have very poor contrast with the white background, making the JSON difficult to read.
            The light colors used (light red, light green, light blue, light gray) likely have contrast ratios well
            below the minimum 4.5:1 ratio required by WCAG guidelines.
          </p>
        </div>

        <h3 className="text-xl font-medium mt-6">Good Contrast - Dark Theme</h3>
        <p>This example shows JSON with colors that provide good contrast against a dark background:</p>
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
          <div className="bg-gray-900 p-4 rounded overflow-x-auto">
            <pre className="text-sm">
              <code>
                <span className="text-gray-300">&#123;</span>
                <br /> <span className="text-pink-400">&quot;name&quot;</span>
                <span className="text-gray-300">:</span> <span className="text-green-400">&quot;Alice&quot;</span>
                <span className="text-gray-300">,</span>
                <br /> <span className="text-pink-400">&quot;age&quot;</span>
                <span className="text-gray-300">:</span> <span className="text-blue-400">30</span>
                <span className="text-gray-300">,</span>
                <br /> <span className="text-pink-400">&quot;isStudent&quot;</span>
                <span className="text-gray-300">:</span> <span className="text-cyan-400">false</span>
                <span className="text-gray-300">,</span>
                <br /> <span className="text-pink-400">&quot;courses&quot;</span>
                <span className="text-gray-300">:</span> <span className="text-gray-300">[</span>
                <br /> <span className="text-green-400">&quot;Math&quot;</span>
                <span className="text-gray-300">,</span>
                <br /> <span className="text-green-400">&quot;Science&quot;</span>
                <span className="text-gray-300">,</span>
          ...
          <p className="mt-2 text-sm">
            The colors above have strong contrast with the dark background, making all elements easily readable. Bright
            pink for keys, bright green for strings, light blue for numbers, and light gray for structural elements all
            provide contrast ratios above the WCAG AA minimum.
          </p>
        </div>
        ...
        <p>Several tools exist to help ensure your syntax highlighting meets accessibility standards:</p>
        ...
        <ol className="list-decimal pl-6 space-y-3 mt-4">
          ...
          <li>
            <strong>Test with color blindness simulators</strong> to ensure your highlighting works for users with
            different types of color vision
          </li>
          <li>
            <strong>Use more than just color</strong> to differentiate elements where possible (e.g., adding subtle font
            weight or style differences)
          </li>
          <li>
            <strong>Provide custom theme options</strong> so users can adjust colors to meet their specific needs
          </li>
          <li>
            <strong>Include at least one high-contrast theme</strong> with very strong contrast ratios well above the
            minimum
          </li>
          <li>
        ...
        <p>
          Good color contrast in JSON syntax highlighting is essential for accessibility and usability. By following
          WCAG guidelines and designing with contrast in mind, developers can create JSON formatters and editors that
          work well for all users, including those with visual impairments or color blindness.
        </p>
        <p className="mt-4">
          Beyond mere compliance with standards, proper contrast creates a better experience for everyone, reducing eye
          strain and making it easier to read and understand JSON data. Whether you're designing a new JSON formatter or
          evaluating existing tools, prioritizing color contrast will significantly improve the user experience.
        </p>
        <p className="mt-4">
