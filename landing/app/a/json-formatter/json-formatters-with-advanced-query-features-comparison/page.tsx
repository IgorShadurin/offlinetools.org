    ...
    <>
      ...
      <div className="space-y-8">
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            <strong>Debugging Large API Responses:</strong> An API returns megabytes of nested JSON. You need to find the value of a specific field, say <code>&quot;orderId&quot;</code>, deeply nested within one of potentially hundreds of items in an array.
          </li>
          <li>
            <strong>Configuration Management:</strong> You have a complex JSON configuration file and need to verify that a specific feature flag is enabled under a certain condition structure.
          </li>
          <li>
            <strong>Log Analysis:</strong> Logs are output as JSON objects per line. You need to filter for errors from a specific module and extract the error message and timestamp.
          </li>
          <li>
            <strong>Data Exploration:</strong> Working with a new dataset in JSON format, you want to quickly see all the unique values for a particular attribute or find objects matching certain criteria.
          </li>
        </ul>
        <p>
...
$..book[-1:]               // The last book (slice)`}
        ...
        <p>
          JSONPath is widely supported and relatively easy to learn for basic paths. Filter expressions (using <code>?()</code>) add powerful conditional selection.
        </p>
...
reservations[*].instances[*].{id: InstanceId, type: InstanceType} // Project and flatten data`}
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            <strong>Which Language?</strong> Does it support JSONPath, JMESPath, a custom syntax, or multiple? Your familiarity and the complexity of queries you need will guide this.
          </li> {/* Added missing closing </li> */}
          <li>
            <strong>Full Specification?</strong> Does it implement the full specification of the chosen language, including filters, functions, and slices?
          </li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          ...
          <li>
            <strong>Highlighting:</strong> Does it highlight the matching elements in the original formatted JSON? This is incredibly useful for visual confirmation and understanding the data structure.
          </li>
          <li>
            <strong>Results View:</strong> How are the query results displayed? As a new formatted JSON object/array, a table, or just highlighted in the original?
          </li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            <strong>Handling Large JSON:</strong> Can the tool handle multi-megabyte or even gigabyte JSON files without crashing or becoming unresponsive?
          </li>
          <li>
            <strong>Query Speed:</strong> How fast are queries executed, especially on large datasets?
          </li>
          <li>
            <strong>Memory Usage:</strong> Does it load the entire JSON into memory? Streaming or partial parsing can be crucial for very large files.
          </li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          ...
          <li>
            <strong>Diffing:</strong> Can it compare two JSON structures and show the differences? <GitCompare className="w-5 h-5 inline-block ml-1 text-gray-500" />
          </li>
          <li>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            <strong>Platform:</strong> Web-based, Desktop application (OS specific?), VS Code extension, Command-line tool?
          </li>
          <li>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            <strong>Dedicated Desktop Applications:</strong> Often offer the richest UIs, best performance on large files, and a wider range of advanced features (diff, schema validation, editing). Examples might be paid software or complex open-source projects.
          </li>
          <li>
            <strong>VS Code Extensions:</strong> Integrate directly into your code editor, providing context-aware formatting, validation, and often basic-to-advanced querying features within a familiar environment. Very convenient for developers.
          </li>
          <li>
            <strong>Online Formatters:</strong> Many now include a query input box, typically supporting JSONPath. Convenient for quick lookups but may struggle with very large files due to browser memory limits and upload/download times. Privacy can also be a concern for sensitive data.
          </li>
          <li>
            <strong>Command-Line Tools (e.g., <code>jq</code>):</strong> While not &quot;formatters&quot; in the sense of a GUI tool, utilities like <code>jq</code> are extremely powerful for querying, filtering, and transforming JSON using a pipe-based command-line interface. Essential for scripting and automation. Learning curve might be steeper for those unfamiliar with command-line pipes and syntax.
            <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
...
# Reads data.json, selects books cheaper than 10, and outputs their titles`}
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            For <strong>quick, one-off checks</strong> on small-to-medium JSON, an online formatter with JSONPath is often sufficient and requires no installation.
          </li>
          <li>
            For <strong>daily development and debugging</strong> within your workflow, a VS Code extension is highly recommended for its integration.
          </li>
          <li>
            For <strong>heavy-duty analysis, large files, or sensitive data</strong>, a dedicated desktop application or a powerful command-line tool like <code>jq</code> might be necessary. Desktop apps offer UI comfort, while CLI tools excel in scripting and performance on massive datasets.
          </li>
          <li>
