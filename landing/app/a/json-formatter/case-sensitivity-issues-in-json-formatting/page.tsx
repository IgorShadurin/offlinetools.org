...
export const metadata: Metadata = {
  ...
  description: "Explore how case sensitivity affects JSON formatting, common pitfalls to avoid, and best practices for handling case-related issues in your JSON documents.",
};
...
export default function JsonFormatterArticle() {
    ...
    <>
      ...
      <div className="space-y-6">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li><strong>Property Names</strong>: <code>"name"</code> and <code>"Name"</code> are considered completely different properties</li>
          <li><strong>String Values</strong>: <code>"Value"</code> and <code>"value"</code> are distinct values</li>
          <li><strong>Reserved Keywords</strong>: Boolean values (<code>true</code>, <code>false</code>) and <code>null</code> must be lowercase</li>
        </ul>
  ...
  "User": "Jane"
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li><strong>Case-Insensitive Databases</strong>: SQL Server, MySQL (with certain collations)</li>
          <li><strong>Case-Insensitive Languages</strong>: HTML attribute names, HTTP headers</li>
          <li><strong>GraphQL</strong>: Can define schemas with case-insensitive field resolution</li>
        </ul>
        <p>
  ...
  "UserID": 456
        ...
        <p>
          JSON requires boolean values to be lowercase (<code>true</code> or <code>false</code>). Using <code>True</code>, <code>FALSE</code>, or any other capitalization will cause parsing errors:
        </p>
        <div className="bg-gray-100 p-4 rounded-md">
          <pre className="bg-white p-3 rounded overflow-x-auto">
            {`// Invalid JSON
...
console.log(variations); // Shows all keys containing "id", "ID", "Id", etc.`}
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li><strong>camelCase</strong>: Commonly used in JavaScript (e.g., <code>userName</code>, <code>isActive</code>)</li>
          <li><strong>snake_case</strong>: Common in Python and Ruby environments (e.g., <code>user_name</code>, <code>is_active</code>)</li>
          <li><strong>PascalCase</strong>: Sometimes used in .NET environments (e.g., <code>UserName</code>, <code>IsActive</code>)</li>
        </ul>
        <p>
