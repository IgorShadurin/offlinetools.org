    ...
    <>
      ...
      <div className="space-y-6">
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            <strong>Enhanced User Experience:</strong> Provides a more immersive and responsive feel, making interactions feel more physical and direct.
          </li>
          <li>
            <strong>Action Confirmation:</strong> A brief vibration can confirm that an action (like saving, deleting a node, or adding a property) was successfully registered by the interface, reducing the need for explicit visual confirmation popups in some cases.
          </li>
          <li>
            <strong>Error Notification:</strong> A distinct vibration pattern can alert the user to an error (e.g., invalid JSON syntax, failed save operation) more immediately than just visual cues, especially if their attention is focused elsewhere on the screen.
          </li>
          <li>
            <strong>Improved Accessibility:</strong> For users with visual impairments, haptic feedback can provide an alternative or supplementary form of notification for critical events.
          </li>
        </ul>
        ...
        <p>
          ...
          (part of the Haptic Feedback API). This API is straightforward, primarily involving the `navigator.vibrate()` method.
        </p>
        ...
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
          <h4 className="text-lg font-medium flex items-center gap-2"><Code size={20} /> Basic Usage:</h4>
...
if ('vibrate' in navigator) {
  ...
  console.warn("Haptic feedback not supported on this device/browser.");
        ...
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
          <h4 className="text-lg font-medium flex items-center gap-2"><BellRing size={20} /> Vibration Pattern:</h4>
...
if ('vibrate' in navigator) {
  navigator.vibrate([100, 50, 100]);
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            <strong>Adding a Property/Item:</strong> A short, crisp vibration (e.g., `navigator.vibrate(50)`) when a new key-value pair is added to an object or a new item is added to an array.
          </li>
          <li>
            <strong>Deleting a Property/Item:</strong> A slightly different or perhaps longer vibration (e.g., `navigator.vibrate(75)`) upon successful deletion.
          </li>
          <li>
            <strong>Saving Changes:</strong> A distinct pattern (e.g., `navigator.vibrate([50, 50, 50])`) when the user successfully saves the JSON document.
          </li>
        </ul>
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
          <h4 className="text-lg font-medium flex items-center gap-2"><Check size={20} /> Example: Confirming Save</h4>
          <div className="bg-white p-3 rounded dark:bg-gray-900 overflow-x-auto">
            <pre>
  ...
  // ... show visual confirmation ...
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            <strong>Invalid JSON Syntax:</strong> A longer, possibly pulsating vibration (e.g., `navigator.vibrate([100, 30, 100, 30, 100])`) when the editor detects syntax errors upon saving or validation.
          </li>
          <li>
            <strong>Failed Operation:</strong> A strong, single vibration (e.g., `navigator.vibrate(200)`) if a backend operation (like saving) fails.
          </li>
        </ul>
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
          <h4 className="text-lg font-medium flex items-center gap-2"><X size={20} /> Example: Notifying Error</h4>
          <div className="bg-white p-3 rounded dark:bg-gray-900 overflow-x-auto">
            <pre>
  ...
  // ... show visual error message ...
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            <strong>Entering/Exiting Edit Mode:</strong> A subtle buzz when transitioning into or out of an in-place editing mode for a value.
          </li>
          <li>
            <strong>Drag and Drop:</strong> A small vibration when a draggable element (like a JSON node) is picked up or successfully dropped into a valid location.
          </li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            <strong>Subtlety is Key:</strong> For most interface actions, short, subtle vibrations are sufficient. Overuse of long or intense vibrations can be jarring.
          </li>
          <li>
            <strong>User Preferences:</strong> Ideally, provide an option in the editor settings for users to enable or disable haptic feedback. Not everyone prefers it.
          </li>
          <li>
            <strong>Contextual Use:</strong> Reserve haptic feedback for important or frequent actions where a tactile confirmation is genuinely helpful. Avoid vibrating for every single keystroke or minor interaction.
          </li>
          <li>
            <strong>Combine with Other Feedback:</strong> Haptic feedback should complement, not replace, visual and auditory feedback. It&apos;s an enhancement, not the sole means of communication.
          </li>
          <li>
            <strong>Accessibility Review:</strong> Ensure that the use of haptics doesn&apos;t negatively impact users who rely on screen readers or other assistive technologies. Providing alternatives is important.
          </li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            <strong>Browser and Device Consistency:</strong> The intensity and feel of vibrations can vary significantly between devices and browsers, making it hard to guarantee a consistent experience.
          </li>
          <li>
            <strong>Lack of Granular Control:</strong> The Vibration API is quite basic. It doesn&apos;t allow control over vibration intensity or more complex haptic patterns that might be available natively on some platforms.
          </li>
          <li>
            <strong>User Settings:</strong> Device-level settings (like system-wide vibration being off) can override browser API calls.
          </li>
        </ul>
