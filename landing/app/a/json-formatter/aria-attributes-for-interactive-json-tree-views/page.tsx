...
export const metadata: Metadata = {
  ...
  description: "Learn how to use ARIA attributes to make interactive JSON tree view components accessible to screen readers and other assistive technologies.",
};
    ...
    <>
      ...
      <div className="space-y-6">
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          ...
          <li>Navigate between nodes (objects, arrays, key-value pairs) using standard keyboard commands (like arrow keys).</li>
        ...
        <p>
          This role is applied to the main container element of the tree view. It identifies the element as a <a href="https://www.w3.org/TR/wai-aria-1.2/#tree" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline dark:text-blue-400">tree widget</a>. This tells assistive technologies to interpret the contained structure as a tree. The element with this role should typically have the keyboard focus, and manage focus internally on the selected <code className="font-mono text-red-600 dark:text-red-400">treeitem</code>.
        </p>
...
&lt;span id="json-tree-label" className="sr-only"&gt;JSON Data Structure&lt;/span&gt;`}
          ...
          <p className="text-sm mt-2">
            Note the use of <code className="font-mono text-red-600 dark:text-red-400">aria-labelledby</code> to provide an accessible name for the tree, pointing to an element containing the label. The <code className="font-mono text-red-600 dark:text-red-400">sr-only</code> class is common for visually hidden elements accessible to screen readers.
          </p>
        </div>
        ...
        <p>
          This role is applied to each node in the tree. In a JSON tree view, this would typically be the element representing a key-value pair, an item in an array, or a nested object/array node that can be expanded/collapsed. A <code className="font-mono text-red-600 dark:text-red-400">treeitem</code> must be contained within an element with role <code className="font-mono text-red-600 dark:text-red-400">tree</code> or <code className="font-mono text-red-600 dark:text-red-400">group</code>.
        </p>
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
...
&lt;/li&gt;`}
        ...
        <p>
          This role is used for elements that contain child <code className="font-mono text-red-600 dark:text-red-400">treeitem</code>s. In a JSON tree, this would be the container (<code className="font-mono text-red-600 dark:text-red-400">&lt;ul&gt;</code> or <code className="font-mono text-red-600 dark:text-red-400">&lt;ol&gt;</code>) immediately under an expandable <code className="font-mono text-red-600 dark:text-red-400">treeitem</code> node (representing a nested object or array). This groups the children belonging to that parent node.
        </p>
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
...
&lt;/li&gt;`}
          ...
          <p className="text-sm mt-2">
            The <code className="font-mono text-red-600 dark:text-red-400">&lt;li role="treeitem"&gt;</code> represents the parent node (<code className="font-mono text-red-600 dark:text-red-400">nestedObject</code>). The <code className="font-mono text-red-600 dark:text-red-400">&lt;ul role="group"&gt;</code> contains its children. Note that the <code className="font-mono text-red-600 dark:text-red-400">role="group"</code> element is typically hidden when <code className="font-mono text-red-600 dark:text-red-400">aria-expanded="false"</code> on the parent <code className="font-mono text-red-600 dark:text-red-400">treeitem</code>.
          </p>
        </div>
        ...
        <p>
          Applied to a <code className="font-mono text-red-600 dark:text-red-400">treeitem</code> that can be expanded or collapsed (i.e., parent nodes like objects or arrays).
        </p>
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li><code className="font-mono text-red-600 dark:text-red-400">aria-expanded="false"</code>: The node is currently collapsed.</li>
          <li><code className="font-mono text-red-600 dark:text-red-400">aria-expanded="true"</code>: The node is currently expanded.</li>
          <li><code className="font-mono text-red-600 dark:text-red-400">aria-expanded="undefined"</code> (or attribute not present): The node is a leaf node and cannot be expanded.</li>
        </ul>
        <p>
          Crucially, the visual state (whether the children are visible) must match the <code className="font-mono text-red-600 dark:text-red-400">aria-expanded</code> value. The interactive element that toggles the expanded state (like a button or the <code className="font-mono text-red-600 dark:text-red-400">treeitem</code> itself if it's a link/button) should control this attribute on the <code className="font-mono text-red-600 dark:text-red-400">treeitem</code> element.
        </p>
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
...
&lt;/li&gt;`}
        ...
        <p>
          Applied to a <code className="font-mono text-red-600 dark:text-red-400">treeitem</code> to indicate if it is currently selected. While a JSON tree view might not always support item selection, if it does (e.g., clicking an item highlights it or loads its details elsewhere), this attribute should be used.
        </p>
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li><code className="font-mono text-red-600 dark:text-red-400">aria-selected="false"</code>: Not selected.</li>
          <li><code className="font-mono text-red-600 dark:text-red-400">aria-selected="true"</code>: Selected.</li>
        </ul>
        <p>
...
&lt;/li&gt;`}
        ...
        <p>
          Applied to each <code className="font-mono text-red-600 dark:text-red-400">treeitem</code> to indicate its depth in the tree hierarchy. The value is an integer greater than or equal to 1. The tree element itself is level 0 conceptually, its direct children are level 1, their children are level 2, and so on.
        </p>
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
...
&lt;/ul&gt;`}
        ...
        <h3 className="text-xl font-semibold mt-6">
          <code className="font-mono text-red-600 dark:text-red-400">aria-posinset</code> and <code className="font-mono text-red-600 dark:text-red-400">aria-setsize</code>
        </h3>
        <p>
          These attributes are used together on a <code className="font-mono text-red-600 dark:text-red-400">treeitem</code> to indicate its position within the set of its siblings at the same level.
        </p>
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li><code className="font-mono text-red-600 dark:text-red-400">aria-posinset</code>: The position of the item within the set (1-based index).</li>
          <li><code className="font-mono text-red-600 dark:text-red-400">aria-setsize</code>: The total number of items in the set (siblings at the same level).</li>
        </ul>
        <p>
...
&lt;/ul&gt;`}
        ...
        <h3 className="text-xl font-semibold mt-6">
          <code className="font-mono text-red-600 dark:text-red-400">aria-labelledby</code> and <code className="font-mono text-red-600 dark:text-red-400">aria-describedby</code>
        </h3>
        <p>
          These attributes associate a <code className="font-mono text-red-600 dark:text-red-400">treeitem</code> with other elements that provide its accessible name and description.
        </p>
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li><code className="font-mono text-red-600 dark:text-red-400">aria-labelledby</code>: Refers to the ID of the element(s) that provide the label for the <code className="font-mono text-red-600 dark:text-red-400">treeitem</code>. For a JSON key-value pair, this would typically point to the element displaying the key name. For an array item, it might point to an element indicating its index, or the value itself if it's a simple value.</li>
          <li><code className="font-mono text-red-600 dark:text-red-400">aria-describedby</code>: Refers to the ID of the element(s) that provide a description for the <code className="font-mono text-red-600 dark:text-red-400">treeitem</code>. This could be used to link to the element displaying the value, the type of the value (object, array, string, number, etc.), or other relevant information.</li>
        </ul>
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
...
&lt;/li&gt;`}
          ...
          <p className="text-sm mt-2">
            Assigning unique IDs to the key/index and value elements allows them to be referenced by <code className="font-mono text-red-600 dark:text-red-400">aria-labelledby</code> and <code className="font-mono text-red-600 dark:text-red-400">aria-describedby</code> on the containing <code className="font-mono text-red-600 dark:text-red-400">treeitem</code>. This provides a rich, semantic description to assistive technologies.
          </p>
        </div>
        ...
        <p>
          This attribute is typically placed on the element with <code className="font-mono text-red-600 dark:text-red-400">role="tree"</code> (the tree container) when implementing <a href="https://www.w3.org/TR/wai-aria-practices-1.1/#kbd_general_guidelines" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline dark:text-blue-400">ARIA Focussed Container pattern</a> for keyboard navigation. Instead of moving the actual browser focus to each <code className="font-mono text-red-600 dark:text-red-400">treeitem</code> as the user navigates with arrow keys, the focus stays on the container, and <code className="font-mono text-red-600 dark:text-red-400">aria-activedescendant</code> is updated to the ID of the currently "active" (virtually focused) <code className="font-mono text-red-600 dark:text-red-400">treeitem</code>. Assistive technologies monitor this attribute to announce the correct item.
        </p>
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
...
&lt;!-- In this state, the tree container element has browser focus,
     but assistive technologies treat "node-items-1" as the active item --&gt;`}
          ...
          <p className="text-sm mt-2">
            Implementing this pattern requires careful management of keyboard events (Up/Down/Left/Right arrow keys) and updating the <code className="font-mono text-red-600 dark:text-red-400">aria-activedescendant</code> attribute on the tree root.
          </p>
        </div>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li><code className="font-mono text-red-600 dark:text-red-400">Arrow Up</code> / <code className="font-mono text-red-600 dark:text-red-400">Arrow Down</code>: Move focus/active descendant to the previous/next visible <code className="font-mono text-red-600 dark:text-red-400">treeitem</code>.</li>
          <li><code className="font-mono text-red-600 dark:text-red-400">Arrow Right</code>:
            <ul className="list-circle pl-6 space-y-1 my-2">
              <li>When focus is on a closed node, opens the node (sets <code className="font-mono text-red-600 dark:text-red-400">aria-expanded="true"</code>).</li>
              <li>When focus is on an open node, moves focus to the first child node.</li>
              <li>When focus is on a leaf node, does nothing.</li>
            </ul>
          </li>
          <li><code className="font-mono text-red-600 dark:text-red-400">Arrow Left</code>:
            <ul className="list-circle pl-6 space-y-1 my-2">
              <li>When focus is on an open node, closes the node (sets <code className="font-mono text-red-600 dark:text-red-400">aria-expanded="false"</code>).</li>
              <li>When focus is on a closed node or a leaf node, moves focus to the parent node.</li>
            </ul>
          </li>
          <li><code className="font-mono text-red-600 dark:text-red-400">Home</code>: Moves focus to the first <code className="font-mono text-red-600 dark:text-red-400">treeitem</code> in the tree.</li>
          <li><code className="font-mono text-red-600 dark:text-red-400">End</code>: Moves focus to the last visible <code className="font-mono text-red-600 dark:text-red-400">treeitem</code> in the tree.</li>
          <li><code className="font-mono text-red-600 dark:text-red-400">Enter</code> or <code className="font-mono text-red-600 dark:text-red-400">Space</code>: Performs the default action for the node (e.g., selecting it, if selection is supported).</li>
        </ul>
        <p>
        ...
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
          <h4 className="text-lg font-medium mb-2">Example: Structure for &#x7b;"name": "Alice", "age": 30, "address": &#x7b;"city": "wonderland"&#x7d;, "tags": ["fiction", "adventure"]&#x7d;</h4>
          <div className="bg-white p-3 rounded dark:bg-gray-900 overflow-x-auto">
            <pre>
...
&lt;/div&gt;`}
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li><strong>Keyboard Navigation:</strong> Try navigating the tree view using only the keyboard (arrow keys, Home, End, Enter). Ensure that focus moves correctly and nodes expand/collapse as expected.</li>
          <li><strong>Screen Reader Testing:</strong> Use a screen reader (e.g., VoiceOver on macOS, NVDA on Windows, JAWS) to interact with the tree view. Listen to what is announced when navigating, expanding, and collapsing nodes. Does it correctly announce the role (<code className="font-mono text-red-600 dark:text-red-400">"tree"</code>, <code className="font-mono text-red-600 dark:text-red-400">"tree item"</code>, <code className="font-mono text-red-600 dark:text-red-400">"group"</code>), the level, position in set, and the label/description of the node?</li>
          <li><strong>Automated Tools:</strong> Use browser extensions (like axe DevTools, Lighthouse) or online validators to check for common ARIA usage errors.</li>
          <li><strong>Manual Code Review:</strong> Double-check that ARIA attributes are correctly applied according to the WAI-ARIA Tree View pattern. Ensure IDs used in <code className="font-mono text-red-600 dark:text-red-400">aria-labelledby</code> and <code className="font-mono text-red-600 dark:text-red-400">aria-describedby</code> correctly point to the intended elements and are unique.</li>
        </ul>
        ...
        <p>
          Creating accessible interactive components like JSON tree views is essential for building inclusive web applications. By applying the appropriate ARIA roles (<code className="font-mono text-red-600 dark:text-red-400">tree</code>, <code className="font-mono text-red-600 dark:text-red-400">treeitem</code>, <code className="font-mono text-red-600 dark:text-red-400">group</code>) and states/properties (<code className="font-mono text-red-600 dark:text-red-400">aria-expanded</code>, <code className="font-mono text-red-600 dark:text-red-400">aria-selected</code>, <code className="font-mono text-red-600 dark:text-red-400">aria-level</code>, <code className="font-mono text-red-600 dark:text-red-400">aria-posinset</code>, <code className="font-mono text-red-600 dark:text-red-400">aria-setsize</code>, <code className="font-mono text-red-600 dark:text-red-400">aria-labelledby</code>, <code className="font-mono text-red-600 dark:text-red-400">aria-describedby</code>, <code className="font-mono text-red-600 dark:text-red-400">aria-activedescendant</code>), along with robust keyboard navigation, you can ensure that users of assistive technologies have a semantic understanding and navigable experience comparable to visual users. Implementing these patterns requires careful attention to detail but is a fundamental step towards building truly accessible user interfaces.
        </p>
      </div>
    </>
  );
