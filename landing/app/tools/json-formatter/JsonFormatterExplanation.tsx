    ...
    <div className="p-6 border rounded-lg bg-card text-card-foreground shadow-sm">
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="mb-2">
            This JSON Formatter takes raw JSON data and transforms it into a well-structured, human-readable format. It
            helps in debugging, understanding, and sharing JSON data by applying consistent indentation and syntax
            highlighting.
          </p>
        ...
        <div>
          ...
          <ol className="list-decimal pl-6 space-y-3">
            ...
            <li>
              ...
              <p>
                Ensure JSON configuration files (like <code>package.json</code> or <code>.eslintrc.json</code>) are
                correctly structured and readable before use.
              </p>
            </li>
        ...
        <div>
          ...
          <p>
            The formatter uses the built-in <code>JSON.parse()</code> to validate the input and{" "}
            <code>JSON.stringify()</code> with appropriate indentation options (spaces or tabs count) to format the
            output. Error handling pinpoints syntax issues, reporting the position where the parsing failed. The core
            logic resides in the shared library for potential reuse across different environments (e.g., web, desktop).
            It&apos;s designed to handle large inputs efficiently within browser memory limits.
          </p>
        </div>
      </div>
    </div>
