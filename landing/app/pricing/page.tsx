        ...
        <Container>
          ...
          <div className="mx-auto max-w-xl mt-10 md:mt-16">
            ...
            <div className="mt-8 text-center text-sm text-muted-foreground">
              ...
              <p className="mt-2">Have questions? <Link href="/contact" className="underline hover:text-foreground">Contact us</Link>.</p>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-2xl mt-16 border-t pt-10">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="mt-2 text-muted-foreground">Yes! Pay once and use OfflineTools forever. No subscriptions, no hidden fees.</p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2 text-muted-foreground">Yes, your license allows you to install OfflineTools on up to 3 personal devices.</p>
              </div>
              
              <div>
                <h3 className="text-lg font-medium">Do you offer refunds?</h3>
                <p className="mt-2 text-muted-foreground">We offer a 30-day money-back guarantee if you&apos;re not satisfied with your purchase.</p>
              </div>
            </div>
          </div>
        </Container>
