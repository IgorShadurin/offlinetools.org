  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      ...
      <div className="space-y-6">
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            <strong>Consistent Formatting:</strong> Every JSON file adheres to the same style rules, regardless of who formatted it.
          </li>
          <li>
            <strong>Reduced Conflicts:</strong> Linter and formatter rules don&apos;t fight each other.
          </li>
          <li>
            <strong>Automated Fixes:</strong> Many linters can automatically fix formatting issues delegated to the formatter.
          </li>
          <li>
          ...
          <li>
            <strong>Faster Code Reviews:</strong> Reviewers can focus on logic and data structure rather than style arguments.
          </li>
        </ul>
        ...
        <ol className="list-decimal pl-6 space-y-2 my-4">
          ...
          <li>Configure ESLint (e.g., &#x60;.eslintrc&#x60;) to extend &#x60;prettier&#x60;, which disables conflicting rules.</li>
...
echo "JSON checks passed."`}
        ...
        <p>
          <span className="font-semibold">Husky</span> allows you to run scripts at various Git hook stages (like &#x60;pre-commit&#x60;). <span className="font-semibold">lint-staged</span> allows you to run commands specifically on the files staged for commit.
        </p>
        <p>
          Steps:
        </p>
        <ol className="list-decimal pl-6 space-y-2 my-4">
          ...
          <li>Configure &#x60;lint-staged&#x60; in your &#x60;package.json&#x60; to run your formatter (e.g., &#x60;prettier --write&#x60;) and linter (e.g., &#x60;eslint --fix&#x60;) on staged JSON files.</li>
        </ol>
        <p>
