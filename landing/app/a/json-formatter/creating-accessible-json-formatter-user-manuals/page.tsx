      ...
      <div className="space-y-6">
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            ...
            </span> Users might rely on screen readers, screen magnifiers, or need high contrast.
          </li>
          <li>
            <span className="font-medium flex items-center">
              <Keyboard className="w-4 h-4 mr-2 text-orange-600" /> Motor Impairments:
            </span> Users might navigate solely with a keyboard, assistive switches, or voice control.
          </li>
          <li>
            <span className="font-medium flex items-center">
              <Brain className="w-4 h-4 mr-2 text-yellow-600" /> Cognitive Impairments:
            </span> Users might benefit from clear, simple language, consistent structure, and easy-to-follow steps.
          </li>
          <li>
            <span className="font-medium flex items-center">
              <Volume2 className="w-4 h-4 mr-2 text-red-600" /> Auditory Impairments:
            </span> While less critical for text-based manuals, consider captions if linking to video tutorials.
          </li>
        </ul>
        <p>
              ...
              {`// A simple JSON object
{
  ...
  "nested": {
    "key": null
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li>
            <span className="font-medium">Document Keyboard Shortcuts:</span> List all keyboard shortcuts for actions like pasting, formatting, copying, collapsing/expanding sections of JSON, finding, and replacing. This is critical for users who cannot use a mouse.
          </li>
          <li>
            <span className="font-medium">Explain UI Accessibility Features:</span> If your formatter has a graphical interface, describe how to use it with a keyboard or screen reader. Mention focus order, ARIA labels (if applicable), and visual indicators for states (e.g., validation errors).
          </li>
          <li>
            <span className="font-medium">Accessible Error Reporting:</span> Explain how the formatter indicates validation or parsing errors. Is it visually clear? Is it conveyed to screen readers? Document the format of error messages.
          </li>
          <li>
            <span className="font-medium">Customization Options:</span> If the formatter allows customization (e.g., color themes, font sizes, indentation levels), highlight how these can be used to improve readability and visual comfort.
          </li>
          <li>
            <span className="font-medium">Output Format Accessibility:</span> If the formatter outputs structured data or diffs, explain the format and how it can be programmatically accessed or interpreted by assistive tech, if relevant. For example, comparing `[&#x7b;...&#x7d;, &#x7b;...&#x7d;]` and `[&#x7b;...&#x7d;, &#x7b;...&#x7d;, &#x7b;...&#x7d;]`.
          </li>
        </ul>
        ...
        <div className="bg-gray-100 p-4 rounded-lg dark:bg-gray-800 my-4">
          ...
          <ul className="list-disc pl-6 space-y-1 my-2">
            <li>Windows/Linux: <code>Ctrl + Shift + F</code></li>
            <li>macOS: <code>Cmd + Shift + F</code></li>
          </ul>

          <h3 className="text-lg font-medium mt-4">Explaining an Error Message:</h3>
          <p>
            If you see the error "Unexpected token <code>&#x7d;</code> at position 50", this means the formatter found a closing curly brace (<code>&#x7d;</code>) where it wasn't expected in your JSON string, specifically at character index 50. Check the syntax around that position for missing commas, incorrect nesting, or unclosed structures (like arrays <code>[</code> or objects <code>&#x7b;</code>).
          </p>
        </div>
