    ...
    <>
      ...
      <div className="space-y-6">
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li className="flex items-start gap-2"><span className="font-medium flex-shrink-0"><Eye className="size-5 inline mr-1 text-purple-500" /> Ubiquitous Access:</span> Developers often need to inspect or format JSON quickly from various devices, not just their primary workstation.</li>
          <li className="flex items-start gap-2"><span className="font-medium flex-shrink-0"><LayoutList className="size-5 inline mr-1 text-purple-500" /> Diverse Workflows:</span> Checking API responses on the go, sharing snippets from a tablet, or pasting large structures from a desktop.</li>
          <li className="flex items-start gap-2"><span className="font-medium flex-shrink-0"><SlidersHorizontal className="size-5 inline mr-1 text-purple-500" /> Focused Experience:</span> Mobile constraints highlight the core features (input, format, copy, validation) and encourage streamlining the interface.</li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li><span className="font-medium">Limited Screen Real Estate:</span> Displaying long keys, values, and indentation becomes difficult.</li>
          <li><span className="font-medium">Input Methods:</span> Pasting large amounts of text can be cumbersome. Typing JSON manually on a mobile keyboard is error-prone.</li>
          <li><span className="font-medium">Readability:</span> Long lines require horizontal scrolling, which is poor UX. Complex structures are hard to visually parse.</li>
          <li><span className="font-medium">Interaction (Touch):</span> Selecting text, copying specific sections, or expanding/collapsing nodes can be tricky with fingers.</li>
          <li><span className="font-medium">Performance:</span> Parsing and formatting large JSON strings can be slow on less powerful mobile devices.</li>
        </ul>
...
+-----------------------+`}
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">Minimal layout focuses on input and output areas stacked vertically.</p>
        </div>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
           <li><span className="font-medium">Generous Button Sizes:</span> Minimum recommended tap target size is 44x44 pixels.</li>
           <li><span className="font-medium">Adequate Spacing:</span> Prevent accidental taps on adjacent elements.</li>
           <li><span className="font-medium">Clear Visual Feedback:</span> Indicate when a button is pressed or an element is selected.</li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li className="flex items-start gap-2"><span className="font-medium flex-shrink-0"><FoldVertical className="size-5 inline mr-1 text-purple-500" /> Collapsible Nodes:</span> Allow users to collapse objects and arrays to hide nested complexity. This drastically improves vertical scanning. On mobile, all nodes might be collapsed by default beyond a certain depth.</li>
          <li className="flex items-start gap-2"><span className="font-medium flex-shrink-0"><Eye className="size-5 inline mr-1 text-purple-500" /> Smart Indentation & Wrapping:</span> Use responsive CSS to adjust indentation levels or wrap long values more aggressively on smaller screens. Word wrapping for string values is crucial.</li>
          <li className="flex items-start gap-2"><span className="font-medium flex-shrink-0"><Search className="size-5 inline mr-1 text-purple-500" /> Search and Filter:</span> Implementing search functionality helps users find specific keys or values in large JSON without endless scrolling. A &quot;jump to error&quot; feature is also vital for validation.</li>
          <li className="flex items-start gap-2"><span className="font-medium flex-shrink-0"><ZoomIn className="size-5 inline mr-1 text-purple-500" /> / <ZoomOut className="size-5 inline mr-1 text-purple-500" /> Font Sizing:</span> Choose a readable base font size and consider allowing users to adjust it or provide slightly larger text on mobile by default.</li>
        </ul>
...
&lt;/div&gt;`}
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">Using collapse toggles (Icon Placeholder / Icon Placeholder) for objects and arrays.</p>
        </div>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li className="flex items-start gap-2"><span className="font-medium flex-shrink-0"><Clipboard className="size-5 inline mr-1 text-purple-500" /> Copy Button:</span> A prominent button to copy the entire formatted output.</li>
          <li className="flex items-start gap-2"><span className="font-medium flex-shrink-0"><Clipboard className="size-5 inline mr-1 text-purple-500" /> / <Code className="size-4 inline" /> Copy Node:</span> (Advanced) If using a tree view, allow tapping on a node to copy its specific value or subtree.</li>
          <li><span className="font-medium">Clear Formatting/Input Button:</span> Easy way to clear the input area.</li>
        </ul>
...
&#x7d;`}
           ...
           <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">Using flexbox to change direction based on screen width.</p>
        </div>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li><span className="font-medium">Efficient Parsing:</span> Use native browser JSON.parse if possible, or a fast library.</li>
          <li><span className="font-medium">Virtualization:</span> For very large output, consider rendering only the visible parts of the JSON tree.</li>
          <li><span className="font-medium">Debounce/Throttle:</span> If auto-formatting on input, limit how often the formatting logic runs.</li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li><span className="font-medium">Improved User Experience:</span> The tool is genuinely usable on a wider range of devices.</li>
          <li><span className="font-medium">Accessibility:</span> Often results in better touch targets and more readable layouts, benefiting users with various needs.</li>
          <li><span className="font-medium">Performance:</span> Focusing on mobile constraints often leads to more efficient code and faster load times for everyone.</li>
          <li><span className="font-medium">Maintainability:</span> Building up from a simple base to a complex one can sometimes be easier to manage.</li>
        </ul>
